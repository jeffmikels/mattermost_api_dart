...
class InsightsApi {
  ...
  Future<TopChannelList?> getTopChannelsForTeam(String teamId, String timeRange, { int? page, int? perPage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TopChannelList',) as TopChannelList;
  ...
  Future<TopReactionList?> getTopChannelsForUser(String userId, String timeRange, { int? page, int? perPage, String? teamId, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TopReactionList',) as TopReactionList;
