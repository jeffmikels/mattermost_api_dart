...
class StatusApi {
  ...
  /// * [List<String>] requestBody (required):
  ///   List of user ids to fetch
  Future<List<Status>?> getUsersStatusesByIds(List<String> requestBody,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<Status>') as List)
        .cast<Status>()
        .toList();
  ...
  ///   User ID
  ///
  /// * [RemoveRecentCustomStatusRequest] removeRecentCustomStatusRequest (required):
  ///   Custom Status object that is to be removed from the recent custom statuses.
  Future<Response> postUserRecentCustomStatusDeleteWithHttpInfo(String userId, RemoveRecentCustomStatusRequest removeRecentCustomStatusRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/status/custom/recent/delete'
      .replaceAll('{user_id}', userId);

    // ignore: prefer_final_locals
    Object? postBody = removeRecentCustomStatusRequest;
  ...
  /// * [RemoveRecentCustomStatusRequest] removeRecentCustomStatusRequest (required):
  ///   Custom Status object that is to be removed from the recent custom statuses.
  Future<void> postUserRecentCustomStatusDelete(String userId, RemoveRecentCustomStatusRequest removeRecentCustomStatusRequest,) async {
    final response = await postUserRecentCustomStatusDeleteWithHttpInfo(userId, removeRecentCustomStatusRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [RemoveRecentCustomStatusRequest] removeRecentCustomStatusRequest (required):
  ///   Custom Status object that is to be removed from the recent custom statuses.
  Future<Response> removeRecentCustomStatusWithHttpInfo(String userId, RemoveRecentCustomStatusRequest removeRecentCustomStatusRequest,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [RemoveRecentCustomStatusRequest] removeRecentCustomStatusRequest (required):
  ///   Custom Status object that is to be removed from the recent custom statuses.
  Future<void> removeRecentCustomStatus(String userId, RemoveRecentCustomStatusRequest removeRecentCustomStatusRequest,) async {
    final response = await removeRecentCustomStatusWithHttpInfo(userId, removeRecentCustomStatusRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   User ID
  ///
  /// * [UpdateUserCustomStatusRequest] updateUserCustomStatusRequest (required):
  ///   Custom status object that is to be updated
  Future<Response> updateUserCustomStatusWithHttpInfo(String userId, UpdateUserCustomStatusRequest updateUserCustomStatusRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/status/custom'
      .replaceAll('{user_id}', userId);

    // ignore: prefer_final_locals
    Object? postBody = updateUserCustomStatusRequest;
  ...
  /// * [UpdateUserCustomStatusRequest] updateUserCustomStatusRequest (required):
  ///   Custom status object that is to be updated
  Future<void> updateUserCustomStatus(String userId, UpdateUserCustomStatusRequest updateUserCustomStatusRequest,) async {
    final response = await updateUserCustomStatusWithHttpInfo(userId, updateUserCustomStatusRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   User ID
  ///
  /// * [UpdateUserStatusRequest] updateUserStatusRequest (required):
  ///   Status object that is to be updated
  Future<Response> updateUserStatusWithHttpInfo(String userId, UpdateUserStatusRequest updateUserStatusRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/users/{user_id}/status'
      .replaceAll('{user_id}', userId);

    // ignore: prefer_final_locals
    Object? postBody = updateUserStatusRequest;
  ...
  /// * [UpdateUserStatusRequest] updateUserStatusRequest (required):
  ///   Status object that is to be updated
  Future<Status?> updateUserStatus(String userId, UpdateUserStatusRequest updateUserStatusRequest,) async {
    final response = await updateUserStatusWithHttpInfo(userId, updateUserStatusRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
