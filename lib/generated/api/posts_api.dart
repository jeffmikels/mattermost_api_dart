...
class PostsApi {
  ...
  Future<Response> createPostWithHttpInfo(CreatePostRequest createPostRequest, { bool? setOnline, }) async {
  ...
  /// * [bool] setOnline:
  ///   Whether to set the user status as online or not.
  Future<Post?> createPost(CreatePostRequest createPostRequest, { bool? setOnline, }) async {
    final response = await createPostWithHttpInfo(createPostRequest,  setOnline: setOnline, );
  ...
  /// Parameters:
  ///
  /// * [CreatePostEphemeralRequest] createPostEphemeralRequest (required):
  ///   Ephemeral Post object to send
  Future<Response> createPostEphemeralWithHttpInfo(CreatePostEphemeralRequest createPostEphemeralRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/posts/ephemeral';

    // ignore: prefer_final_locals
    Object? postBody = createPostEphemeralRequest;
  ...
  /// * [CreatePostEphemeralRequest] createPostEphemeralRequest (required):
  ///   Ephemeral Post object to send
  Future<Post?> createPostEphemeral(CreatePostEphemeralRequest createPostEphemeralRequest,) async {
    final response = await createPostEphemeralWithHttpInfo(createPostEphemeralRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] includeDeleted:
  ///   Defines if result should include deleted posts, must have 'manage_system' (admin) permission.
  Future<List<FileInfo>?> getFileInfosForPost(String postId, { bool? includeDeleted, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<FileInfo>') as List)
        .cast<FileInfo>()
        .toList();
  ...
  /// * [int] perPage:
  ///   The number of posts per page
  Future<List<PostList>?> getFlaggedPostsForUser(String userId, { String? teamId, String? channelId, int? page, int? perPage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<PostList>') as List)
        .cast<PostList>()
        .toList();
  ...
  /// * [bool] includeDeleted:
  ///   Defines if result should include deleted posts, must have 'manage_system' (admin) permission.
  Future<Post?> getPost(String postId, { bool? includeDeleted, }) async {
  ...
  /// * [bool] collapsedThreadsExtended:
  ///   Whether to return the associated users as part of the response or not
  Future<PostList?> getPostThread(String postId, { int? perPage, String? fromPost, int? fromCreateAt, String? direction, bool? skipFetchThreads, bool? collapsedThreads, bool? collapsedThreadsExtended, }) async {
  ...
  /// * [bool] collapsedThreadsExtended:
  ///   Whether to return the associated users as part of the response or not
  Future<PostList?> getPostsAroundLastUnread(String userId, String channelId, { int? limitBefore, int? limitAfter, bool? skipFetchThreads, bool? collapsedThreads, bool? collapsedThreadsExtended, }) async {
  ...
  /// * [List<String>] requestBody (required):
  ///   List of post ids
  Future<List<Post>?> getPostsByIds(List<String> requestBody,) async {
  ...
  ///   Post GUID
  ///
  /// * [PatchPostRequest] patchPostRequest (required):
  ///   Post object that is to be updated
  Future<Response> patchPostWithHttpInfo(String postId, PatchPostRequest patchPostRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/posts/{post_id}/patch'
      .replaceAll('{post_id}', postId);

    // ignore: prefer_final_locals
    Object? postBody = patchPostRequest;
  ...
  /// * [PatchPostRequest] patchPostRequest (required):
  ///   Post object that is to be updated
  Future<Post?> patchPost(String postId, PatchPostRequest patchPostRequest,) async {
    final response = await patchPostWithHttpInfo(postId, patchPostRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///   Team GUID
  ///
  /// * [SearchPostsRequest] searchPostsRequest (required):
  ///   The search terms and logic to use in the search.
  Future<Response> searchPostsWithHttpInfo(String teamId, SearchPostsRequest searchPostsRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/teams/{team_id}/posts/search'
      .replaceAll('{team_id}', teamId);

    // ignore: prefer_final_locals
    Object? postBody = searchPostsRequest;
  ...
  /// * [SearchPostsRequest] searchPostsRequest (required):
  ///   The search terms and logic to use in the search.
  Future<PostListWithSearchMatches?> searchPosts(String teamId, SearchPostsRequest searchPostsRequest,) async {
    final response = await searchPostsWithHttpInfo(teamId, searchPostsRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PostListWithSearchMatches',) as PostListWithSearchMatches;
  ...
  Future<ChannelUnreadAt?> setPostUnread(String userId, String postId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ChannelUnreadAt',) as ChannelUnreadAt;
  ...
  ///   Post object that is to be updated
  Future<Response> updatePostWithHttpInfo(String postId, UpdatePostRequest updatePostRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/posts/{post_id}'
      .replaceAll('{post_id}', postId);
  ...
  /// * [UpdatePostRequest] updatePostRequest (required):
  ///   Post object that is to be updated
  Future<Post?> updatePost(String postId, UpdatePostRequest updatePostRequest,) async {
    final response = await updatePostWithHttpInfo(postId, updatePostRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
