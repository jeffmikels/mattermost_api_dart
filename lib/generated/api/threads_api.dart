...
class ThreadsApi {
  ThreadsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<UserThreads?> getUserThreads(String userId, String teamId, { int? since, bool? deleted, bool? extended, int? page, int? pageSize, bool? totalsOnly, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'UserThreads',) as UserThreads;
