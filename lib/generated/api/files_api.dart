...
class FilesApi {
  ...
  /// * [String] fileId (required):
  ///   The ID of the file to get a link for
  Future<GetFileLink200Response?> getFileLink(String fileId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetFileLink200Response',) as GetFileLink200Response;
  ...
  /// * [String] clientIds:
  ///   A unique identifier for the file that will be returned in the response
  Future<UploadFile201Response?> uploadFile({ String? channelId, String? filename, MultipartFile? files, String? channelId2, String? clientIds, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'UploadFile201Response',) as UploadFile201Response;
