...
class MattermostEnvironmentConfigRateLimitSettings {
  /// Returns a new [MattermostEnvironmentConfigRateLimitSettings] instance.
  MattermostEnvironmentConfigRateLimitSettings({
    this.enable,
    this.perSec,
    this.maxBurst,
  ...
  /// Returns a new [MattermostEnvironmentConfigRateLimitSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigRateLimitSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostEnvironmentConfigRateLimitSettings(
  ...
  static List<MattermostEnvironmentConfigRateLimitSettings>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigRateLimitSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigRateLimitSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigRateLimitSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigRateLimitSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
