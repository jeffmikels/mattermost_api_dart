...
class MattermostGetGroupStats200Response {
  /// Returns a new [MattermostGetGroupStats200Response] instance.
  ...
  /// Returns a new [MattermostGetGroupStats200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostGetGroupStats200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostGetGroupStats200Response(
  ...
  static List<MattermostGetGroupStats200Response>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostGetGroupStats200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostGetGroupStats200Response> mapFromJson(dynamic json) {
    final map = <String, MattermostGetGroupStats200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostGetGroupStats200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
