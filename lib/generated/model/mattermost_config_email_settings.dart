...
class MattermostConfigEmailSettings {
  ...
  bool operator ==(Object other) =>
      ...
      other is MattermostConfigEmailSettings &&
  ...
  static List<MattermostConfigEmailSettings>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MattermostConfigEmailSettings>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigEmailSettings.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
