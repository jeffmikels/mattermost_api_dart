...
class MattermostEnvironmentConfigAnalyticsSettings {
  /// Returns a new [MattermostEnvironmentConfigAnalyticsSettings] instance.
  MattermostEnvironmentConfigAnalyticsSettings({
  ...
  /// Returns a new [MattermostEnvironmentConfigAnalyticsSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigAnalyticsSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostEnvironmentConfigAnalyticsSettings(
  ...
  static List<MattermostEnvironmentConfigAnalyticsSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigAnalyticsSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigAnalyticsSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigAnalyticsSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigAnalyticsSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
