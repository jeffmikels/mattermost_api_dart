...
class MattermostEnvironmentConfigTeamSettings {
  /// Returns a new [MattermostEnvironmentConfigTeamSettings] instance.
  MattermostEnvironmentConfigTeamSettings({
    this.siteName,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MattermostEnvironmentConfigTeamSettings &&
  ...
  /// Returns a new [MattermostEnvironmentConfigTeamSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigTeamSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostEnvironmentConfigTeamSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostEnvironmentConfigTeamSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostEnvironmentConfigTeamSettings(
        ...
        restrictCreationToDomains: mapValueOfType<bool>(json, r'RestrictCreationToDomains'),
        enableCustomBrand: mapValueOfType<bool>(json, r'EnableCustomBrand'),
        customBrandText: mapValueOfType<bool>(json, r'CustomBrandText'),
        customDescriptionText: mapValueOfType<bool>(json, r'CustomDescriptionText'),
        restrictDirectMessage: mapValueOfType<bool>(json, r'RestrictDirectMessage'),
        restrictTeamInvite: mapValueOfType<bool>(json, r'RestrictTeamInvite'),
        restrictPublicChannelManagement: mapValueOfType<bool>(json, r'RestrictPublicChannelManagement'),
        restrictPrivateChannelManagement: mapValueOfType<bool>(json, r'RestrictPrivateChannelManagement'),
        restrictPublicChannelCreation: mapValueOfType<bool>(json, r'RestrictPublicChannelCreation'),
        restrictPrivateChannelCreation: mapValueOfType<bool>(json, r'RestrictPrivateChannelCreation'),
        restrictPublicChannelDeletion: mapValueOfType<bool>(json, r'RestrictPublicChannelDeletion'),
        restrictPrivateChannelDeletion: mapValueOfType<bool>(json, r'RestrictPrivateChannelDeletion'),
        userStatusAwayTimeout: mapValueOfType<bool>(json, r'UserStatusAwayTimeout'),
        maxChannelsPerTeam: mapValueOfType<bool>(json, r'MaxChannelsPerTeam'),
        maxNotificationsPerChannel: mapValueOfType<bool>(json, r'MaxNotificationsPerChannel'),
      );
    }
    return null;
  }

  static List<MattermostEnvironmentConfigTeamSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MattermostEnvironmentConfigTeamSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigTeamSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigTeamSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigTeamSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigTeamSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MattermostEnvironmentConfigTeamSettings-objects as value to a dart map
  static Map<String, List<MattermostEnvironmentConfigTeamSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MattermostEnvironmentConfigTeamSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigTeamSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
