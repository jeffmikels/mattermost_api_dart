...
class MattermostTeamUnread {
  /// Returns a new [MattermostTeamUnread] instance.
  ...
  /// Returns a new [MattermostTeamUnread] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostTeamUnread? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostTeamUnread[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostTeamUnread[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostTeamUnread(
  ...
  static List<MattermostTeamUnread>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostTeamUnread.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostTeamUnread> mapFromJson(dynamic json) {
    final map = <String, MattermostTeamUnread>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostTeamUnread.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
