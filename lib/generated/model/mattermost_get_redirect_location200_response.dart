...
class MattermostGetRedirectLocation200Response {
  /// Returns a new [MattermostGetRedirectLocation200Response] instance.
  ...
  /// Returns a new [MattermostGetRedirectLocation200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostGetRedirectLocation200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostGetRedirectLocation200Response(
  ...
  static List<MattermostGetRedirectLocation200Response>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostGetRedirectLocation200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostGetRedirectLocation200Response> mapFromJson(dynamic json) {
    final map = <String, MattermostGetRedirectLocation200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostGetRedirectLocation200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
