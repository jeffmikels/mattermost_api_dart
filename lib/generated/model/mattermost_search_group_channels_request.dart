...
class MattermostSearchGroupChannelsRequest {
  /// Returns a new [MattermostSearchGroupChannelsRequest] instance.
  ...
  /// Returns a new [MattermostSearchGroupChannelsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSearchGroupChannelsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostSearchGroupChannelsRequest(
  ...
  static List<MattermostSearchGroupChannelsRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSearchGroupChannelsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSearchGroupChannelsRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSearchGroupChannelsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSearchGroupChannelsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
