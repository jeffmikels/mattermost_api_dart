...
class MattermostLoginRequest {
  /// Returns a new [MattermostLoginRequest] instance.
  ...
  /// Returns a new [MattermostLoginRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostLoginRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostLoginRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostLoginRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostLoginRequest(
  ...
  static List<MattermostLoginRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostLoginRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostLoginRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostLoginRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostLoginRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
