...
class Subscription {
  ...
  @override
  String toString() => 'Subscription[id=$id, customerId=$customerId, productId=$productId, addOns=$addOns, startAt=$startAt, endAt=$endAt, createAt=$createAt, seats=$seats, dns=$dns]';
