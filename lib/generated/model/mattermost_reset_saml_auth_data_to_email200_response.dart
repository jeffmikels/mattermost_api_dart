...
class MattermostResetSamlAuthDataToEmail200Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is MattermostResetSamlAuthDataToEmail200Response && other.numAffected == numAffected;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "MattermostResetSamlAuthDataToEmail200Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "MattermostResetSamlAuthDataToEmail200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostResetSamlAuthDataToEmail200Response>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MattermostResetSamlAuthDataToEmail200Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostResetSamlAuthDataToEmail200Response.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
