...
class ConfigFileSettings {
  /// Returns a new [ConfigFileSettings] instance.
  ConfigFileSettings({
    this.maxFileSize,
    this.driverName,
    this.directory,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConfigFileSettings &&
  ...
  /// Returns a new [ConfigFileSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConfigFileSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConfigFileSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConfigFileSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ConfigFileSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConfigFileSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConfigFileSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConfigFileSettings> mapFromJson(dynamic json) {
    final map = <String, ConfigFileSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigFileSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConfigFileSettings-objects as value to a dart map
  static Map<String, List<ConfigFileSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConfigFileSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigFileSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
