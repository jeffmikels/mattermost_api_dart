...
class UpdatePostRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UpdatePostRequest &&
     other.id == id &&
  ...
  @override
  String toString() => 'UpdatePostRequest[id=$id, isPinned=$isPinned, message=$message, hasReactions=$hasReactions, props=$props]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdatePostRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdatePostRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdatePostRequest>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UpdatePostRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UpdatePostRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdatePostRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
