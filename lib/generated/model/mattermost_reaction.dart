...
class MattermostReaction {
  /// Returns a new [MattermostReaction] instance.
  MattermostReaction({
    this.userId,
    this.postId,
    this.emojiName,
  ...
  /// Returns a new [MattermostReaction] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostReaction? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostReaction[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostReaction[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostReaction>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostReaction.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostReaction> mapFromJson(dynamic json) {
    final map = <String, MattermostReaction>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostReaction.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
