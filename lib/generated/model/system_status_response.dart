...
class SystemStatusResponse {
  /// Returns a new [SystemStatusResponse] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SystemStatusResponse &&
  ...
  /// Returns a new [SystemStatusResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SystemStatusResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SystemStatusResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SystemStatusResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SystemStatusResponse>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SystemStatusResponse>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SystemStatusResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SystemStatusResponse> mapFromJson(dynamic json) {
    final map = <String, SystemStatusResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SystemStatusResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SystemStatusResponse-objects as value to a dart map
  static Map<String, List<SystemStatusResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SystemStatusResponse>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SystemStatusResponse.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
