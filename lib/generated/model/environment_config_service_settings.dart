...
class EnvironmentConfigServiceSettings {
  /// Returns a new [EnvironmentConfigServiceSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvironmentConfigServiceSettings &&
  ...
  /// Returns a new [EnvironmentConfigServiceSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvironmentConfigServiceSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvironmentConfigServiceSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvironmentConfigServiceSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EnvironmentConfigServiceSettings(
  ...
  static List<EnvironmentConfigServiceSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvironmentConfigServiceSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvironmentConfigServiceSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvironmentConfigServiceSettings> mapFromJson(dynamic json) {
    final map = <String, EnvironmentConfigServiceSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigServiceSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvironmentConfigServiceSettings-objects as value to a dart map
  static Map<String, List<EnvironmentConfigServiceSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvironmentConfigServiceSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigServiceSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
