...
class EnvironmentConfigFileSettings {
  /// Returns a new [EnvironmentConfigFileSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvironmentConfigFileSettings &&
  ...
  /// Returns a new [EnvironmentConfigFileSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvironmentConfigFileSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvironmentConfigFileSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvironmentConfigFileSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EnvironmentConfigFileSettings(
  ...
  static List<EnvironmentConfigFileSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvironmentConfigFileSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvironmentConfigFileSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvironmentConfigFileSettings> mapFromJson(dynamic json) {
    final map = <String, EnvironmentConfigFileSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigFileSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvironmentConfigFileSettings-objects as value to a dart map
  static Map<String, List<EnvironmentConfigFileSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvironmentConfigFileSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigFileSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
