...
class MattermostConfigFileSettings {
  ...
  bool operator ==(Object other) =>
      ...
      other is MattermostConfigFileSettings &&
  ...
  static List<MattermostConfigFileSettings>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MattermostConfigFileSettings>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigFileSettings.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
