...
class MattermostNotice {
  /// Returns a new [MattermostNotice] instance.
  MattermostNotice({
    this.id,
    this.sysAdminOnly,
    this.teamAdminOnly,
  ...
  /// Returns a new [MattermostNotice] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostNotice? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostNotice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostNotice[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostNotice(
  ...
  static List<MattermostNotice>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostNotice.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostNotice> mapFromJson(dynamic json) {
    final map = <String, MattermostNotice>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostNotice.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
