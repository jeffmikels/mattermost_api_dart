...
class MattermostUpdateUserRequest {
  /// Returns a new [MattermostUpdateUserRequest] instance.
  ...
  /// Returns a new [MattermostUpdateUserRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUpdateUserRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostUpdateUserRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostUpdateUserRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostUpdateUserRequest(
        ...
        timezone: MattermostTimezone.fromJson(json[r'timezone']),
  ...
  static List<MattermostUpdateUserRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUpdateUserRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUpdateUserRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostUpdateUserRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUpdateUserRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
