...
class ConfigEmailSettings {
  /// Returns a new [ConfigEmailSettings] instance.
  ConfigEmailSettings({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConfigEmailSettings &&
  ...
  /// Returns a new [ConfigEmailSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConfigEmailSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConfigEmailSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConfigEmailSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ConfigEmailSettings(
  ...
  static List<ConfigEmailSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConfigEmailSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConfigEmailSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConfigEmailSettings> mapFromJson(dynamic json) {
    final map = <String, ConfigEmailSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigEmailSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConfigEmailSettings-objects as value to a dart map
  static Map<String, List<ConfigEmailSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConfigEmailSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigEmailSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
