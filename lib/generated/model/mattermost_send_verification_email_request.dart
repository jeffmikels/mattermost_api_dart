...
class MattermostSendVerificationEmailRequest {
  /// Returns a new [MattermostSendVerificationEmailRequest] instance.
  ...
  /// Returns a new [MattermostSendVerificationEmailRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSendVerificationEmailRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostSendVerificationEmailRequest(
  ...
  static List<MattermostSendVerificationEmailRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSendVerificationEmailRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSendVerificationEmailRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSendVerificationEmailRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSendVerificationEmailRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
