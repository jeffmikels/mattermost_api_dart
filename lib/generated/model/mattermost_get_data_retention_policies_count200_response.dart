...
class MattermostGetDataRetentionPoliciesCount200Response {
  /// Returns a new [MattermostGetDataRetentionPoliciesCount200Response] instance.
  ...
  /// Returns a new [MattermostGetDataRetentionPoliciesCount200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostGetDataRetentionPoliciesCount200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostGetDataRetentionPoliciesCount200Response(
  ...
  static List<MattermostGetDataRetentionPoliciesCount200Response>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostGetDataRetentionPoliciesCount200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostGetDataRetentionPoliciesCount200Response> mapFromJson(dynamic json) {
    final map = <String, MattermostGetDataRetentionPoliciesCount200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostGetDataRetentionPoliciesCount200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
