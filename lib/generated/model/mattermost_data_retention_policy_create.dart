...
class MattermostDataRetentionPolicyCreate {
  ...
  bool operator ==(Object other) =>
      ...
      other is MattermostDataRetentionPolicyCreate &&
  ...
  @override
  String toString() =>
      'MattermostDataRetentionPolicyCreate[displayName=$displayName, postDuration=$postDuration, teamIds=$teamIds, channelIds=$channelIds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(
              json.containsKey(key), 'Required key "MattermostDataRetentionPolicyCreate[$key]" is missing from JSON.');
          assert(
              json[key] != null, 'Required key "MattermostDataRetentionPolicyCreate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostDataRetentionPolicyCreate>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MattermostDataRetentionPolicyCreate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostDataRetentionPolicyCreate.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
