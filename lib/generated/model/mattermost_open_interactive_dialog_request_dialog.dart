...
class MattermostOpenInteractiveDialogRequestDialog {
  /// Returns a new [MattermostOpenInteractiveDialogRequestDialog] instance.
  MattermostOpenInteractiveDialogRequestDialog({
    this.callbackId,
    required this.title,
  ...
  /// Returns a new [MattermostOpenInteractiveDialogRequestDialog] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostOpenInteractiveDialogRequestDialog? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostOpenInteractiveDialogRequestDialog(
  ...
  static List<MattermostOpenInteractiveDialogRequestDialog>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostOpenInteractiveDialogRequestDialog.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostOpenInteractiveDialogRequestDialog> mapFromJson(dynamic json) {
    final map = <String, MattermostOpenInteractiveDialogRequestDialog>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostOpenInteractiveDialogRequestDialog.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
