...
class MattermostSubmitInteractiveDialogRequest {
  /// Returns a new [MattermostSubmitInteractiveDialogRequest] instance.
  ...
  /// Returns a new [MattermostSubmitInteractiveDialogRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSubmitInteractiveDialogRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostSubmitInteractiveDialogRequest(
  ...
  static List<MattermostSubmitInteractiveDialogRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSubmitInteractiveDialogRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSubmitInteractiveDialogRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSubmitInteractiveDialogRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSubmitInteractiveDialogRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
