...
class MattermostCloudCustomer {
  /// Returns a new [MattermostCloudCustomer] instance.
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  MattermostAddress? billingAddress;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  MattermostAddress? companyAddress;
  ...
  /// Returns a new [MattermostCloudCustomer] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCloudCustomer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCloudCustomer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCloudCustomer[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostCloudCustomer(
        ...
        billingAddress: MattermostAddress.fromJson(json[r'billing_address']),
        companyAddress: MattermostAddress.fromJson(json[r'company_address']),
        paymentMethod: MattermostPaymentMethod.fromJson(json[r'payment_method']),
      );
    }
    return null;
  }
  ...
  static List<MattermostCloudCustomer>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCloudCustomer.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCloudCustomer> mapFromJson(dynamic json) {
    final map = <String, MattermostCloudCustomer>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCloudCustomer.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
