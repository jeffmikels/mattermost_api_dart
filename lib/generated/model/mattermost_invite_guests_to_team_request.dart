...
class MattermostInviteGuestsToTeamRequest {
  /// Returns a new [MattermostInviteGuestsToTeamRequest] instance.
  ...
  /// Returns a new [MattermostInviteGuestsToTeamRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostInviteGuestsToTeamRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MattermostInviteGuestsToTeamRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostInviteGuestsToTeamRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostInviteGuestsToTeamRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostInviteGuestsToTeamRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostInviteGuestsToTeamRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
