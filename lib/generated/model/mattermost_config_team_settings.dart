...
class MattermostConfigTeamSettings {
  /// Returns a new [MattermostConfigTeamSettings] instance.
  MattermostConfigTeamSettings({
    this.siteName,
  ...
  /// Returns a new [MattermostConfigTeamSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConfigTeamSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConfigTeamSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConfigTeamSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostConfigTeamSettings(
  ...
  static List<MattermostConfigTeamSettings>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConfigTeamSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConfigTeamSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostConfigTeamSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigTeamSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
