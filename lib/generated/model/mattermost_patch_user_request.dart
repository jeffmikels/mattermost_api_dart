...
class MattermostPatchUserRequest {
  /// Returns a new [MattermostPatchUserRequest] instance.
  ...
  /// Returns a new [MattermostPatchUserRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPatchUserRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPatchUserRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPatchUserRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostPatchUserRequest(
  ...
  static List<MattermostPatchUserRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPatchUserRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPatchUserRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostPatchUserRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPatchUserRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
