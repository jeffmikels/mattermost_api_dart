...
class MattermostSearchPostsRequest {
  /// Returns a new [MattermostSearchPostsRequest] instance.
  ...
  /// Returns a new [MattermostSearchPostsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSearchPostsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSearchPostsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSearchPostsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostSearchPostsRequest(
  ...
  static List<MattermostSearchPostsRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSearchPostsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSearchPostsRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSearchPostsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSearchPostsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
