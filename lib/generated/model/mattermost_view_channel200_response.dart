...
class MattermostViewChannel200Response {
  /// Returns a new [MattermostViewChannel200Response] instance.
  ...
  /// Returns a new [MattermostViewChannel200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostViewChannel200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostViewChannel200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostViewChannel200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostViewChannel200Response(
  ...
  static List<MattermostViewChannel200Response>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostViewChannel200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostViewChannel200Response> mapFromJson(dynamic json) {
    final map = <String, MattermostViewChannel200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostViewChannel200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
