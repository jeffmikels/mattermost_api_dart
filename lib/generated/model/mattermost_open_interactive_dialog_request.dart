...
class MattermostOpenInteractiveDialogRequest {
  /// Returns a new [MattermostOpenInteractiveDialogRequest] instance.
  ...
  /// Returns a new [MattermostOpenInteractiveDialogRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostOpenInteractiveDialogRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostOpenInteractiveDialogRequest(
        triggerId: mapValueOfType<String>(json, r'trigger_id')!,
        url: mapValueOfType<String>(json, r'url')!,
        dialog: MattermostOpenInteractiveDialogRequestDialog.fromJson(json[r'dialog'])!,
      );
    }
    return null;
  }
  ...
  static List<MattermostOpenInteractiveDialogRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostOpenInteractiveDialogRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostOpenInteractiveDialogRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostOpenInteractiveDialogRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostOpenInteractiveDialogRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
