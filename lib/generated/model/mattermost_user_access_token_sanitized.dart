...
class MattermostUserAccessTokenSanitized {
  /// Returns a new [MattermostUserAccessTokenSanitized] instance.
  ...
  /// Returns a new [MattermostUserAccessTokenSanitized] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUserAccessTokenSanitized? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostUserAccessTokenSanitized(
  ...
  static List<MattermostUserAccessTokenSanitized>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUserAccessTokenSanitized.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUserAccessTokenSanitized> mapFromJson(dynamic json) {
    final map = <String, MattermostUserAccessTokenSanitized>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUserAccessTokenSanitized.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
