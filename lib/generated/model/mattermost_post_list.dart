...
class MattermostPostList {
  /// Returns a new [MattermostPostList] instance.
  MattermostPostList({
    this.order = const [],
    this.posts = const {},
    this.nextPostId,
  ...
  /// Returns a new [MattermostPostList] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPostList? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPostList[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPostList[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostPostList>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPostList.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPostList> mapFromJson(dynamic json) {
    final map = <String, MattermostPostList>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPostList.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
