...
class MattermostEnvironmentConfigServiceSettings {
  /// Returns a new [MattermostEnvironmentConfigServiceSettings] instance.
  MattermostEnvironmentConfigServiceSettings({
    this.siteURL,
    this.listenAddress,
  ...
  /// Returns a new [MattermostEnvironmentConfigServiceSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigServiceSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostEnvironmentConfigServiceSettings(
  ...
  static List<MattermostEnvironmentConfigServiceSettings>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigServiceSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigServiceSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigServiceSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigServiceSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
