...
class MattermostCreatePostRequest {
  /// Returns a new [MattermostCreatePostRequest] instance.
  ...
  /// Returns a new [MattermostCreatePostRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCreatePostRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCreatePostRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCreatePostRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostCreatePostRequest(
  ...
  static List<MattermostCreatePostRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCreatePostRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCreatePostRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostCreatePostRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCreatePostRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
