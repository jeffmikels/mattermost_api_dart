...
class MattermostUserThread {
  /// Returns a new [MattermostUserThread] instance.
  ...
  List<MattermostPost> participants;
  ...
  /// Returns a new [MattermostUserThread] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUserThread? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostUserThread[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostUserThread[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostUserThread(
        ...
        participants: MattermostPost.listFromJson(json[r'participants']) ?? const [],
        post: MattermostPost.fromJson(json[r'post']),
      );
    }
    return null;
  }
  ...
  static List<MattermostUserThread>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUserThread.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUserThread> mapFromJson(dynamic json) {
    final map = <String, MattermostUserThread>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUserThread.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
