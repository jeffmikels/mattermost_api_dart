...
class MattermostRemoteClusterInfo {
  /// Returns a new [MattermostRemoteClusterInfo] instance.
  ...
  /// Returns a new [MattermostRemoteClusterInfo] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostRemoteClusterInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostRemoteClusterInfo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostRemoteClusterInfo[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostRemoteClusterInfo(
  ...
  static List<MattermostRemoteClusterInfo>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostRemoteClusterInfo.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostRemoteClusterInfo> mapFromJson(dynamic json) {
    final map = <String, MattermostRemoteClusterInfo>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostRemoteClusterInfo.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
