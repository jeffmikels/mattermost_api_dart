...
class EnvironmentConfigEmailSettings {
  /// Returns a new [EnvironmentConfigEmailSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvironmentConfigEmailSettings &&
  ...
  /// Returns a new [EnvironmentConfigEmailSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvironmentConfigEmailSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvironmentConfigEmailSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvironmentConfigEmailSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EnvironmentConfigEmailSettings(
  ...
  static List<EnvironmentConfigEmailSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvironmentConfigEmailSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvironmentConfigEmailSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvironmentConfigEmailSettings> mapFromJson(dynamic json) {
    final map = <String, EnvironmentConfigEmailSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigEmailSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvironmentConfigEmailSettings-objects as value to a dart map
  static Map<String, List<EnvironmentConfigEmailSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvironmentConfigEmailSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigEmailSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
