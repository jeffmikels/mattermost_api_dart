...
class MattermostSearchTeams200Response {
  /// Returns a new [MattermostSearchTeams200Response] instance.
  ...
  /// Returns a new [MattermostSearchTeams200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSearchTeams200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSearchTeams200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSearchTeams200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostSearchTeams200Response>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSearchTeams200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSearchTeams200Response> mapFromJson(dynamic json) {
    final map = <String, MattermostSearchTeams200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSearchTeams200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
