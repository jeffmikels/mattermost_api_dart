...
class MattermostOrderedSidebarCategories {
  /// Returns a new [MattermostOrderedSidebarCategories] instance.
  MattermostOrderedSidebarCategories({
    this.order = const [],
  ...
  /// Returns a new [MattermostOrderedSidebarCategories] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostOrderedSidebarCategories? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MattermostOrderedSidebarCategories>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostOrderedSidebarCategories.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostOrderedSidebarCategories> mapFromJson(dynamic json) {
    final map = <String, MattermostOrderedSidebarCategories>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostOrderedSidebarCategories.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
