...
class MattermostCreateIncomingWebhookRequest {
  /// Returns a new [MattermostCreateIncomingWebhookRequest] instance.
  ...
  /// Returns a new [MattermostCreateIncomingWebhookRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCreateIncomingWebhookRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostCreateIncomingWebhookRequest(
  ...
  static List<MattermostCreateIncomingWebhookRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCreateIncomingWebhookRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCreateIncomingWebhookRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostCreateIncomingWebhookRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCreateIncomingWebhookRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
