...
class MattermostSession {
  /// Returns a new [MattermostSession] instance.
  MattermostSession({
    this.createAt,
    this.deviceId,
    this.expiresAt,
  ...
  List<MattermostTeamMember> teamMembers;
  ...
  /// Returns a new [MattermostSession] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSession? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSession[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSession[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return MattermostSession(
        ...
        teamMembers: MattermostTeamMember.listFromJson(json[r'team_members']) ?? const [],
  ...
  static List<MattermostSession>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSession.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSession> mapFromJson(dynamic json) {
    final map = <String, MattermostSession>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSession.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
