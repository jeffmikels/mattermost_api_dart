...
class CreateUploadRequest {
  ...
  @override
  String toString() => 'CreateUploadRequest[channelId=$channelId, filename=$filename, fileSize=$fileSize]';
  ...
  static Map<String, List<CreateUploadRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateUploadRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
