...
class GlobalDataRetentionPolicy {
  /// Returns a new [GlobalDataRetentionPolicy] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GlobalDataRetentionPolicy &&
  ...
  @override
  String toString() => 'GlobalDataRetentionPolicy[messageDeletionEnabled=$messageDeletionEnabled, fileDeletionEnabled=$fileDeletionEnabled, messageRetentionCutoff=$messageRetentionCutoff, fileRetentionCutoff=$fileRetentionCutoff]';
  ...
  /// Returns a new [GlobalDataRetentionPolicy] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GlobalDataRetentionPolicy? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GlobalDataRetentionPolicy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GlobalDataRetentionPolicy[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return GlobalDataRetentionPolicy(
  ...
  static List<GlobalDataRetentionPolicy>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GlobalDataRetentionPolicy>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GlobalDataRetentionPolicy.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GlobalDataRetentionPolicy> mapFromJson(dynamic json) {
    final map = <String, GlobalDataRetentionPolicy>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GlobalDataRetentionPolicy.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GlobalDataRetentionPolicy-objects as value to a dart map
  static Map<String, List<GlobalDataRetentionPolicy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GlobalDataRetentionPolicy>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GlobalDataRetentionPolicy.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
