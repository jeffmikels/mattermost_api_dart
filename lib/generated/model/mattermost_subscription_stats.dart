...
class MattermostSubscriptionStats {
  /// Returns a new [MattermostSubscriptionStats] instance.
  ...
  /// Returns a new [MattermostSubscriptionStats] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSubscriptionStats? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSubscriptionStats[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSubscriptionStats[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostSubscriptionStats(
  ...
  static List<MattermostSubscriptionStats>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSubscriptionStats.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSubscriptionStats> mapFromJson(dynamic json) {
    final map = <String, MattermostSubscriptionStats>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSubscriptionStats.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
