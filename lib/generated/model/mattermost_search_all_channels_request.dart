...
class MattermostSearchAllChannelsRequest {
  /// Returns a new [MattermostSearchAllChannelsRequest] instance.
  ...
  /// Returns a new [MattermostSearchAllChannelsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSearchAllChannelsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostSearchAllChannelsRequest(
  ...
  static List<MattermostSearchAllChannelsRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSearchAllChannelsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSearchAllChannelsRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSearchAllChannelsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSearchAllChannelsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
