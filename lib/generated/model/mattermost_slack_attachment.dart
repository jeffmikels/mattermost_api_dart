...
class MattermostSlackAttachment {
  /// Returns a new [MattermostSlackAttachment] instance.
  MattermostSlackAttachment({
    this.id,
    this.fallback,
    this.color,
    this.pretext,
  ...
  List<MattermostSlackAttachmentField> fields;
  ...
  /// Returns a new [MattermostSlackAttachment] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSlackAttachment? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSlackAttachment[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSlackAttachment[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostSlackAttachment(
        ...
        fields: MattermostSlackAttachmentField.listFromJson(json[r'Fields']) ?? const [],
  ...
  static List<MattermostSlackAttachment>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSlackAttachment.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSlackAttachment> mapFromJson(dynamic json) {
    final map = <String, MattermostSlackAttachment>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSlackAttachment.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
