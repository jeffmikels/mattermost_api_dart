...
class MattermostConfigServiceSettings {
  ...
  bool operator ==(Object other) =>
      ...
      other is MattermostConfigServiceSettings &&
  ...
  static List<MattermostConfigServiceSettings>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MattermostConfigServiceSettings>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigServiceSettings.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
