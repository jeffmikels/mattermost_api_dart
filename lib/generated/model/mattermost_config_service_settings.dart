...
class MattermostConfigServiceSettings {
  /// Returns a new [MattermostConfigServiceSettings] instance.
  MattermostConfigServiceSettings({
    this.siteURL,
    this.listenAddress,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MattermostConfigServiceSettings &&
  ...
  /// Returns a new [MattermostConfigServiceSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConfigServiceSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConfigServiceSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConfigServiceSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostConfigServiceSettings(
  ...
  static List<MattermostConfigServiceSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MattermostConfigServiceSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConfigServiceSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConfigServiceSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostConfigServiceSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigServiceSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MattermostConfigServiceSettings-objects as value to a dart map
  static Map<String, List<MattermostConfigServiceSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MattermostConfigServiceSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigServiceSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
