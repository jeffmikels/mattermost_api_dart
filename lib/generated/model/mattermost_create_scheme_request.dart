...
class MattermostCreateSchemeRequest {
  /// Returns a new [MattermostCreateSchemeRequest] instance.
  ...
  /// Returns a new [MattermostCreateSchemeRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCreateSchemeRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCreateSchemeRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCreateSchemeRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostCreateSchemeRequest(
  ...
  static List<MattermostCreateSchemeRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCreateSchemeRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCreateSchemeRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostCreateSchemeRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCreateSchemeRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
