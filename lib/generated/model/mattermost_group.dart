...
class MattermostGroup {
  /// Returns a new [MattermostGroup] instance.
  MattermostGroup({
    this.id,
    this.name,
    this.displayName,
  ...
  /// Returns a new [MattermostGroup] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostGroup? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostGroup[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostGroup[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostGroup>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostGroup.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostGroup> mapFromJson(dynamic json) {
    final map = <String, MattermostGroup>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostGroup.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
