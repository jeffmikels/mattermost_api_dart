...
class MattermostPatchChannelRequest {
  /// Returns a new [MattermostPatchChannelRequest] instance.
  ...
  /// Returns a new [MattermostPatchChannelRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPatchChannelRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPatchChannelRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPatchChannelRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostPatchChannelRequest(
  ...
  static List<MattermostPatchChannelRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPatchChannelRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPatchChannelRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostPatchChannelRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPatchChannelRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
