...
class MattermostUpdateTeamRequest {
  /// Returns a new [MattermostUpdateTeamRequest] instance.
  ...
  /// Returns a new [MattermostUpdateTeamRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUpdateTeamRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostUpdateTeamRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostUpdateTeamRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostUpdateTeamRequest(
  ...
  static List<MattermostUpdateTeamRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUpdateTeamRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUpdateTeamRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostUpdateTeamRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUpdateTeamRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
