...
class MattermostCreateGroupRequest {
  /// Returns a new [MattermostCreateGroupRequest] instance.
  MattermostCreateGroupRequest({
    required this.group,
    this.userIds = const [],
  });

  MattermostCreateGroupRequestGroup group;
  ...
  /// Returns a new [MattermostCreateGroupRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCreateGroupRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCreateGroupRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCreateGroupRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostCreateGroupRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCreateGroupRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCreateGroupRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostCreateGroupRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCreateGroupRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
