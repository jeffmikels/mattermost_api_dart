...
class MattermostMarketplacePlugin {
  /// Returns a new [MattermostMarketplacePlugin] instance.
  MattermostMarketplacePlugin({
    this.homepageUrl,
    this.iconData,
    this.downloadUrl,
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  MattermostPluginManifest? manifest;
  ...
  /// Returns a new [MattermostMarketplacePlugin] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostMarketplacePlugin? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostMarketplacePlugin[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostMarketplacePlugin[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostMarketplacePlugin(
  ...
  static List<MattermostMarketplacePlugin>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostMarketplacePlugin.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostMarketplacePlugin> mapFromJson(dynamic json) {
    final map = <String, MattermostMarketplacePlugin>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostMarketplacePlugin.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
