...
class MattermostCompliance {
  /// Returns a new [MattermostCompliance] instance.
  ...
  /// Returns a new [MattermostCompliance] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCompliance? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCompliance[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCompliance[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostCompliance(
  ...
  static List<MattermostCompliance>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCompliance.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCompliance> mapFromJson(dynamic json) {
    final map = <String, MattermostCompliance>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCompliance.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
