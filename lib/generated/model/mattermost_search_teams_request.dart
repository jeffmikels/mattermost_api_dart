...
class MattermostSearchTeamsRequest {
  /// Returns a new [MattermostSearchTeamsRequest] instance.
  ...
  /// Returns a new [MattermostSearchTeamsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSearchTeamsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSearchTeamsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSearchTeamsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostSearchTeamsRequest(
  ...
  static List<MattermostSearchTeamsRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSearchTeamsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSearchTeamsRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSearchTeamsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSearchTeamsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
