...
class MattermostPatchSchemeRequest {
  /// Returns a new [MattermostPatchSchemeRequest] instance.
  ...
  /// Returns a new [MattermostPatchSchemeRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPatchSchemeRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPatchSchemeRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPatchSchemeRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostPatchSchemeRequest(
  ...
  static List<MattermostPatchSchemeRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPatchSchemeRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPatchSchemeRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostPatchSchemeRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPatchSchemeRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
