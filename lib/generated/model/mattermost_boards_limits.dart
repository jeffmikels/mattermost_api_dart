...
class MattermostBoardsLimits {
  /// Returns a new [MattermostBoardsLimits] instance.
  MattermostBoardsLimits({
    this.cards,
    this.views,
  });
  ...
  /// Returns a new [MattermostBoardsLimits] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostBoardsLimits? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostBoardsLimits[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostBoardsLimits[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostBoardsLimits(
  ...
  static List<MattermostBoardsLimits>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostBoardsLimits.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostBoardsLimits> mapFromJson(dynamic json) {
    final map = <String, MattermostBoardsLimits>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostBoardsLimits.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
