...
class MattermostRegenCommandToken200Response {
  /// Returns a new [MattermostRegenCommandToken200Response] instance.
  ...
  /// Returns a new [MattermostRegenCommandToken200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostRegenCommandToken200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostRegenCommandToken200Response(
  ...
  static List<MattermostRegenCommandToken200Response>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostRegenCommandToken200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostRegenCommandToken200Response> mapFromJson(dynamic json) {
    final map = <String, MattermostRegenCommandToken200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostRegenCommandToken200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
