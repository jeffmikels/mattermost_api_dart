...
class MattermostEnvironmentConfigLogSettings {
  /// Returns a new [MattermostEnvironmentConfigLogSettings] instance.
  MattermostEnvironmentConfigLogSettings({
    this.enableConsole,
    this.consoleLevel,
    this.enableFile,
    this.fileLevel,
  ...
  /// Returns a new [MattermostEnvironmentConfigLogSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigLogSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostEnvironmentConfigLogSettings(
  ...
  static List<MattermostEnvironmentConfigLogSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigLogSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigLogSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigLogSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigLogSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
