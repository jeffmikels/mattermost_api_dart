...
class MattermostLoginByCwsTokenRequest {
  /// Returns a new [MattermostLoginByCwsTokenRequest] instance.
  ...
  /// Returns a new [MattermostLoginByCwsTokenRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostLoginByCwsTokenRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostLoginByCwsTokenRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostLoginByCwsTokenRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostLoginByCwsTokenRequest(
  ...
  static List<MattermostLoginByCwsTokenRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostLoginByCwsTokenRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostLoginByCwsTokenRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostLoginByCwsTokenRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostLoginByCwsTokenRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
