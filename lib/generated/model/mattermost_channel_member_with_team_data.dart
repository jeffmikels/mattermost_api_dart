...
class MattermostChannelMemberWithTeamData {
  /// Returns a new [MattermostChannelMemberWithTeamData] instance.
  MattermostChannelMemberWithTeamData({
    this.channelId,
    this.userId,
    this.roles,
    this.lastViewedAt,
  ...
  /// Returns a new [MattermostChannelMemberWithTeamData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostChannelMemberWithTeamData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostChannelMemberWithTeamData(
  ...
  static List<MattermostChannelMemberWithTeamData>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostChannelMemberWithTeamData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostChannelMemberWithTeamData> mapFromJson(dynamic json) {
    final map = <String, MattermostChannelMemberWithTeamData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostChannelMemberWithTeamData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
