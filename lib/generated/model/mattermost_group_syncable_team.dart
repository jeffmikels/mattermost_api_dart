...
class MattermostGroupSyncableTeam {
  /// Returns a new [MattermostGroupSyncableTeam] instance.
  ...
  /// Returns a new [MattermostGroupSyncableTeam] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostGroupSyncableTeam? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostGroupSyncableTeam[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostGroupSyncableTeam[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostGroupSyncableTeam(
  ...
  static List<MattermostGroupSyncableTeam>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostGroupSyncableTeam.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostGroupSyncableTeam> mapFromJson(dynamic json) {
    final map = <String, MattermostGroupSyncableTeam>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostGroupSyncableTeam.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
