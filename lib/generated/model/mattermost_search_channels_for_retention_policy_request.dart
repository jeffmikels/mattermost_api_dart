...
class MattermostSearchChannelsForRetentionPolicyRequest {
  /// Returns a new [MattermostSearchChannelsForRetentionPolicyRequest] instance.
  ...
  /// Returns a new [MattermostSearchChannelsForRetentionPolicyRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSearchChannelsForRetentionPolicyRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MattermostSearchChannelsForRetentionPolicyRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSearchChannelsForRetentionPolicyRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSearchChannelsForRetentionPolicyRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSearchChannelsForRetentionPolicyRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSearchChannelsForRetentionPolicyRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
