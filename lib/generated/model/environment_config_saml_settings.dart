...
class EnvironmentConfigSamlSettings {
  /// Returns a new [EnvironmentConfigSamlSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvironmentConfigSamlSettings &&
     other.enable == enable &&
     other.verify == verify &&
  ...
  /// Returns a new [EnvironmentConfigSamlSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvironmentConfigSamlSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvironmentConfigSamlSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvironmentConfigSamlSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EnvironmentConfigSamlSettings(
  ...
  static List<EnvironmentConfigSamlSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvironmentConfigSamlSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvironmentConfigSamlSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvironmentConfigSamlSettings> mapFromJson(dynamic json) {
    final map = <String, EnvironmentConfigSamlSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigSamlSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvironmentConfigSamlSettings-objects as value to a dart map
  static Map<String, List<EnvironmentConfigSamlSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvironmentConfigSamlSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigSamlSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
