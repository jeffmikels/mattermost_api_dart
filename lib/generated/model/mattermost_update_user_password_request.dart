...
class MattermostUpdateUserPasswordRequest {
  /// Returns a new [MattermostUpdateUserPasswordRequest] instance.
  ...
  /// Returns a new [MattermostUpdateUserPasswordRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUpdateUserPasswordRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostUpdateUserPasswordRequest(
  ...
  static List<MattermostUpdateUserPasswordRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUpdateUserPasswordRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUpdateUserPasswordRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostUpdateUserPasswordRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUpdateUserPasswordRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
