...
class MattermostOAuthApp {
  /// Returns a new [MattermostOAuthApp] instance.
  MattermostOAuthApp({
    this.id,
    this.clientSecret,
    this.name,
  ...
  /// Returns a new [MattermostOAuthApp] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostOAuthApp? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostOAuthApp[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostOAuthApp[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostOAuthApp(
  ...
  static List<MattermostOAuthApp>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostOAuthApp.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostOAuthApp> mapFromJson(dynamic json) {
    final map = <String, MattermostOAuthApp>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostOAuthApp.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
