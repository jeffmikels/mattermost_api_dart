...
class MattermostChannelModeratedRole {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MattermostChannelModeratedRole &&
     other.value == value &&
  ...
  static List<MattermostChannelModeratedRole>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<MattermostChannelModeratedRole>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MattermostChannelModeratedRole>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostChannelModeratedRole.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
