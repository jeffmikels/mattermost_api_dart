...
class MattermostExecuteCommandRequest {
  /// Returns a new [MattermostExecuteCommandRequest] instance.
  ...
  /// Returns a new [MattermostExecuteCommandRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostExecuteCommandRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostExecuteCommandRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostExecuteCommandRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostExecuteCommandRequest(
  ...
  static List<MattermostExecuteCommandRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostExecuteCommandRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostExecuteCommandRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostExecuteCommandRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostExecuteCommandRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
