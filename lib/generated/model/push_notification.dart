...
class PushNotification {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PushNotification &&
     other.ackId == ackId &&
  ...
  /// Returns a new [PushNotification] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PushNotification? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PushNotification[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PushNotification[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PushNotification>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PushNotification>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PushNotification.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PushNotification> mapFromJson(dynamic json) {
    final map = <String, PushNotification>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PushNotification.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PushNotification-objects as value to a dart map
  static Map<String, List<PushNotification>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PushNotification>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PushNotification.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
