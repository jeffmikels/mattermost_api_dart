...
class MattermostAddGroupMembersRequest {
  /// Returns a new [MattermostAddGroupMembersRequest] instance.
  ...
  /// Returns a new [MattermostAddGroupMembersRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostAddGroupMembersRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostAddGroupMembersRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostAddGroupMembersRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostAddGroupMembersRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostAddGroupMembersRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostAddGroupMembersRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostAddGroupMembersRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostAddGroupMembersRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
