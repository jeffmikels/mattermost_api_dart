...
class MattermostUpdateOutgoingWebhookRequest {
  /// Returns a new [MattermostUpdateOutgoingWebhookRequest] instance.
  ...
  /// Returns a new [MattermostUpdateOutgoingWebhookRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUpdateOutgoingWebhookRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostUpdateOutgoingWebhookRequest(
  ...
  static List<MattermostUpdateOutgoingWebhookRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUpdateOutgoingWebhookRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUpdateOutgoingWebhookRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostUpdateOutgoingWebhookRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUpdateOutgoingWebhookRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
