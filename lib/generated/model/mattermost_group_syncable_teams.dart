...
class MattermostGroupSyncableTeams {
  /// Returns a new [MattermostGroupSyncableTeams] instance.
  MattermostGroupSyncableTeams({
    this.teamId,
  ...
  /// Returns a new [MattermostGroupSyncableTeams] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostGroupSyncableTeams? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostGroupSyncableTeams[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostGroupSyncableTeams[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostGroupSyncableTeams(
  ...
  static List<MattermostGroupSyncableTeams>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostGroupSyncableTeams.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostGroupSyncableTeams> mapFromJson(dynamic json) {
    final map = <String, MattermostGroupSyncableTeams>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostGroupSyncableTeams.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
