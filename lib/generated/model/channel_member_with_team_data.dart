...
class ChannelMemberWithTeamData {
  /// Returns a new [ChannelMemberWithTeamData] instance.
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  ChannelNotifyProps? notifyProps;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChannelMemberWithTeamData &&
  ...
  @override
  String toString() => 'ChannelMemberWithTeamData[channelId=$channelId, userId=$userId, roles=$roles, lastViewedAt=$lastViewedAt, msgCount=$msgCount, mentionCount=$mentionCount, notifyProps=$notifyProps, lastUpdateAt=$lastUpdateAt, teamDisplayName=$teamDisplayName, teamName=$teamName, teamUpdateAt=$teamUpdateAt]';
  ...
  /// Returns a new [ChannelMemberWithTeamData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ChannelMemberWithTeamData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChannelMemberWithTeamData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChannelMemberWithTeamData[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ChannelMemberWithTeamData(
        ...
        notifyProps: ChannelNotifyProps.fromJson(json[r'notify_props']),
  ...
  static List<ChannelMemberWithTeamData>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChannelMemberWithTeamData>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChannelMemberWithTeamData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ChannelMemberWithTeamData> mapFromJson(dynamic json) {
    final map = <String, ChannelMemberWithTeamData>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChannelMemberWithTeamData.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ChannelMemberWithTeamData-objects as value to a dart map
  static Map<String, List<ChannelMemberWithTeamData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChannelMemberWithTeamData>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChannelMemberWithTeamData.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
