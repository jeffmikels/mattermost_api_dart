...
class MattermostOpenGraphArticleAuthorsInner {
  /// Returns a new [MattermostOpenGraphArticleAuthorsInner] instance.
  MattermostOpenGraphArticleAuthorsInner({
    this.firstName,
    this.lastName,
    this.username,
    this.gender,
  ...
  /// Returns a new [MattermostOpenGraphArticleAuthorsInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostOpenGraphArticleAuthorsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostOpenGraphArticleAuthorsInner(
  ...
  static List<MattermostOpenGraphArticleAuthorsInner>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostOpenGraphArticleAuthorsInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostOpenGraphArticleAuthorsInner> mapFromJson(dynamic json) {
    final map = <String, MattermostOpenGraphArticleAuthorsInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostOpenGraphArticleAuthorsInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
