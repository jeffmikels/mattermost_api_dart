...
class MattermostPreference {
  /// Returns a new [MattermostPreference] instance.
  ...
  /// Returns a new [MattermostPreference] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPreference? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPreference[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPreference[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostPreference(
  ...
  static List<MattermostPreference>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPreference.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPreference> mapFromJson(dynamic json) {
    final map = <String, MattermostPreference>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPreference.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
