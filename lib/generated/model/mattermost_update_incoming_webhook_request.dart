...
class MattermostUpdateIncomingWebhookRequest {
  /// Returns a new [MattermostUpdateIncomingWebhookRequest] instance.
  ...
  /// Returns a new [MattermostUpdateIncomingWebhookRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUpdateIncomingWebhookRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostUpdateIncomingWebhookRequest(
  ...
  static List<MattermostUpdateIncomingWebhookRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUpdateIncomingWebhookRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUpdateIncomingWebhookRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostUpdateIncomingWebhookRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUpdateIncomingWebhookRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
