...
class EnvironmentConfigLdapSettings {
  /// Returns a new [EnvironmentConfigLdapSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EnvironmentConfigLdapSettings &&
     other.enable == enable &&
  ...
  @override
  String toString() => 'EnvironmentConfigLdapSettings[enable=$enable, ldapServer=$ldapServer, ldapPort=$ldapPort, connectionSecurity=$connectionSecurity, baseDN=$baseDN, bindUsername=$bindUsername, bindPassword=$bindPassword, userFilter=$userFilter, firstNameAttribute=$firstNameAttribute, lastNameAttribute=$lastNameAttribute, emailAttribute=$emailAttribute, usernameAttribute=$usernameAttribute, nicknameAttribute=$nicknameAttribute, idAttribute=$idAttribute, positionAttribute=$positionAttribute, syncIntervalMinutes=$syncIntervalMinutes, skipCertificateVerification=$skipCertificateVerification, queryTimeout=$queryTimeout, maxPageSize=$maxPageSize, loginFieldName=$loginFieldName]';
  ...
  /// Returns a new [EnvironmentConfigLdapSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EnvironmentConfigLdapSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EnvironmentConfigLdapSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EnvironmentConfigLdapSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EnvironmentConfigLdapSettings(
  ...
  static List<EnvironmentConfigLdapSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EnvironmentConfigLdapSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EnvironmentConfigLdapSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EnvironmentConfigLdapSettings> mapFromJson(dynamic json) {
    final map = <String, EnvironmentConfigLdapSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigLdapSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EnvironmentConfigLdapSettings-objects as value to a dart map
  static Map<String, List<EnvironmentConfigLdapSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EnvironmentConfigLdapSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EnvironmentConfigLdapSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
