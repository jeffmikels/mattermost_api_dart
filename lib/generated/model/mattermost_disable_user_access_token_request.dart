...
class MattermostDisableUserAccessTokenRequest {
  /// Returns a new [MattermostDisableUserAccessTokenRequest] instance.
  ...
  /// Returns a new [MattermostDisableUserAccessTokenRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostDisableUserAccessTokenRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostDisableUserAccessTokenRequest(
  ...
  static List<MattermostDisableUserAccessTokenRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostDisableUserAccessTokenRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostDisableUserAccessTokenRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostDisableUserAccessTokenRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostDisableUserAccessTokenRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
