...
class MattermostConvertBotToUserRequest {
  /// Returns a new [MattermostConvertBotToUserRequest] instance.
  ...
  /// Returns a new [MattermostConvertBotToUserRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConvertBotToUserRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConvertBotToUserRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConvertBotToUserRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostConvertBotToUserRequest(
  ...
  static List<MattermostConvertBotToUserRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConvertBotToUserRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConvertBotToUserRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostConvertBotToUserRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConvertBotToUserRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
