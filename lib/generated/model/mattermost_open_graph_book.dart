...
class MattermostOpenGraphBook {
  /// Returns a new [MattermostOpenGraphBook] instance.
  MattermostOpenGraphBook({
    this.isbn,
    this.releaseDate,
    this.tags = const [],
    this.authors = const [],
  ...
  /// Returns a new [MattermostOpenGraphBook] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostOpenGraphBook? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostOpenGraphBook[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostOpenGraphBook[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostOpenGraphBook>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostOpenGraphBook.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostOpenGraphBook> mapFromJson(dynamic json) {
    final map = <String, MattermostOpenGraphBook>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostOpenGraphBook.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
