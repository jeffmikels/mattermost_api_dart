...
class MattermostUpdateUserStatusRequest {
  /// Returns a new [MattermostUpdateUserStatusRequest] instance.
  ...
  /// Returns a new [MattermostUpdateUserStatusRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostUpdateUserStatusRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostUpdateUserStatusRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostUpdateUserStatusRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostUpdateUserStatusRequest(
  ...
  static List<MattermostUpdateUserStatusRequest>? listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostUpdateUserStatusRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostUpdateUserStatusRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostUpdateUserStatusRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostUpdateUserStatusRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
