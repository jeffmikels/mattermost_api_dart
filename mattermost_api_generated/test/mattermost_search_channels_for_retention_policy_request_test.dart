...
// tests for MattermostSearchChannelsForRetentionPolicyRequest
void main() {
  // final instance = MattermostSearchChannelsForRetentionPolicyRequest();

  group('test MattermostSearchChannelsForRetentionPolicyRequest', () {
