...
void main() {
  ...
  group('tests for UsersApi', () {
    ...
    //
    //Future getProfileImage(String userId, { num  }) async
    ...
    //
    //Future loginByCwsToken(LoginByCwsTokenRequest loginByCwsTokenRequest) async
    ...
    //
    //Future publishUserTyping(String userId, { PublishUserTypingRequest publishUserTypingRequest }) async
