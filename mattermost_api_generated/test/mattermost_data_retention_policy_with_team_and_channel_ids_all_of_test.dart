...
// tests for MattermostDataRetentionPolicyWithTeamAndChannelIdsAllOf
void main() {
  // final instance = MattermostDataRetentionPolicyWithTeamAndChannelIdsAllOf();

  group('test MattermostDataRetentionPolicyWithTeamAndChannelIdsAllOf', () {
