...
// tests for MattermostDataRetentionPolicyWithTeamAndChannelCounts
void main() {
  // final instance = MattermostDataRetentionPolicyWithTeamAndChannelCounts();

  group('test MattermostDataRetentionPolicyWithTeamAndChannelCounts', () {
