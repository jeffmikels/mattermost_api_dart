...
// tests for MattermostViewChannelRequest
void main() {
  // final instance = MattermostViewChannelRequest();

  group('test MattermostViewChannelRequest', () {
    ...
    test('to test the property `prevChannelId`', () async {
      // TODO
    });
