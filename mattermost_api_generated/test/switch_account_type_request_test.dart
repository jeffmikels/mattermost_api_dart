...
// tests for SwitchAccountTypeRequest
void main() {
  // final instance = SwitchAccountTypeRequest();

  group('test SwitchAccountTypeRequest', () {
    ...
    // String newService
    test('to test the property `newService`', () async {
      // TODO
    });
    ...
    // String ldapId
    test('to test the property `ldapId`', () async {
      // TODO
    });
