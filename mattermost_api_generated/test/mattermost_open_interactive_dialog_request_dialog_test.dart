...
// tests for MattermostOpenInteractiveDialogRequestDialog
void main() {
  // final instance = MattermostOpenInteractiveDialogRequestDialog();

  group('test MattermostOpenInteractiveDialogRequestDialog', () {
    ...
    // List<Map> elements (default value: const [])
