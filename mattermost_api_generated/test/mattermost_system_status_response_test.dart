...
// tests for MattermostSystemStatusResponse
void main() {
  // final instance = MattermostSystemStatusResponse();

  group('test MattermostSystemStatusResponse', () {
    ...
    test('to test the property `canReceiveNotifications`', () async {
      // TODO
    });
