...
// tests for SearchChannelsForRetentionPolicyRequest
void main() {
  // final instance = SearchChannelsForRetentionPolicyRequest();

  group('test SearchChannelsForRetentionPolicyRequest', () {
