...
void main() {
  ...
  group('tests for StatusApi', () {
    ...
    //
    //Future postUserRecentCustomStatusDelete(String userId, RemoveRecentCustomStatusRequest removeRecentCustomStatusRequest) async
    ...
    // Deletes a user's recent custom status by removing the specific status from the recentCustomStatuses in the user's props and updates the user. ##### Permissions Must be logged in as the user whose recent custom status is being deleted. 
    //
    //Future removeRecentCustomStatus(String userId, RemoveRecentCustomStatusRequest removeRecentCustomStatusRequest) async
    ...
    //
    //Future updateUserCustomStatus(String userId, UpdateUserCustomStatusRequest updateUserCustomStatusRequest) async
