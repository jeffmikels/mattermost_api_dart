...
class MattermostPluginManifestServerExecutables {
  /// Returns a new [MattermostPluginManifestServerExecutables] instance.
  MattermostPluginManifestServerExecutables({
    this.linuxAmd64,
    this.darwinAmd64,
    this.windowsAmd64,
  });
  ...
  /// Returns a new [MattermostPluginManifestServerExecutables] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPluginManifestServerExecutables? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostPluginManifestServerExecutables(
  ...
  static List<MattermostPluginManifestServerExecutables>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPluginManifestServerExecutables.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPluginManifestServerExecutables> mapFromJson(dynamic json) {
    final map = <String, MattermostPluginManifestServerExecutables>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPluginManifestServerExecutables.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
