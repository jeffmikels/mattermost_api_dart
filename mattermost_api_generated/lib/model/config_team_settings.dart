...
class ConfigTeamSettings {
  /// Returns a new [ConfigTeamSettings] instance.
  ConfigTeamSettings({
    this.siteName,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConfigTeamSettings &&
  ...
  /// Returns a new [ConfigTeamSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConfigTeamSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConfigTeamSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConfigTeamSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ConfigTeamSettings(
  ...
  static List<ConfigTeamSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConfigTeamSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConfigTeamSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConfigTeamSettings> mapFromJson(dynamic json) {
    final map = <String, ConfigTeamSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigTeamSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConfigTeamSettings-objects as value to a dart map
  static Map<String, List<ConfigTeamSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConfigTeamSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigTeamSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
