...
class Notice {
  ...
  @override
  String toString() => 'Notice[id=$id, sysAdminOnly=$sysAdminOnly, teamAdminOnly=$teamAdminOnly, action=$action, actionParam=$actionParam, actionText=$actionText, description=$description, image=$image, title=$title]';
