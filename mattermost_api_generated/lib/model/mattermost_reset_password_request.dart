...
class MattermostResetPasswordRequest {
  /// Returns a new [MattermostResetPasswordRequest] instance.
  ...
  /// Returns a new [MattermostResetPasswordRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostResetPasswordRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostResetPasswordRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostResetPasswordRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostResetPasswordRequest(
  ...
  static List<MattermostResetPasswordRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostResetPasswordRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostResetPasswordRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostResetPasswordRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostResetPasswordRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
