...
class MattermostEnvironmentConfigPasswordSettings {
  /// Returns a new [MattermostEnvironmentConfigPasswordSettings] instance.
  MattermostEnvironmentConfigPasswordSettings({
    this.minimumLength,
    this.lowercase,
    this.number,
    this.uppercase,
  ...
  /// Returns a new [MattermostEnvironmentConfigPasswordSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigPasswordSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostEnvironmentConfigPasswordSettings(
  ...
  static List<MattermostEnvironmentConfigPasswordSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigPasswordSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigPasswordSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigPasswordSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigPasswordSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
