...
class Config {
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  ConfigGitLabSettings? googleSettings;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  ConfigGitLabSettings? office365Settings;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  ConfigAnalyticsSettings? analyticsSettings;
  ...
  static Config? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Config(
        serviceSettings: ConfigServiceSettings.fromJson(json[r'ServiceSettings']),
        teamSettings: ConfigTeamSettings.fromJson(json[r'TeamSettings']),
        sqlSettings: ConfigSqlSettings.fromJson(json[r'SqlSettings']),
        logSettings: ConfigLogSettings.fromJson(json[r'LogSettings']),
        passwordSettings: ConfigPasswordSettings.fromJson(json[r'PasswordSettings']),
        fileSettings: ConfigFileSettings.fromJson(json[r'FileSettings']),
        emailSettings: ConfigEmailSettings.fromJson(json[r'EmailSettings']),
        rateLimitSettings: ConfigRateLimitSettings.fromJson(json[r'RateLimitSettings']),
        privacySettings: ConfigPrivacySettings.fromJson(json[r'PrivacySettings']),
        supportSettings: ConfigSupportSettings.fromJson(json[r'SupportSettings']),
        gitLabSettings: ConfigGitLabSettings.fromJson(json[r'GitLabSettings']),
        googleSettings: ConfigGitLabSettings.fromJson(json[r'GoogleSettings']),
        office365Settings: ConfigGitLabSettings.fromJson(json[r'Office365Settings']),
        ldapSettings: ConfigLdapSettings.fromJson(json[r'LdapSettings']),
        complianceSettings: ConfigComplianceSettings.fromJson(json[r'ComplianceSettings']),
        localizationSettings: ConfigLocalizationSettings.fromJson(json[r'LocalizationSettings']),
        samlSettings: ConfigSamlSettings.fromJson(json[r'SamlSettings']),
        nativeAppSettings: ConfigNativeAppSettings.fromJson(json[r'NativeAppSettings']),
        clusterSettings: ConfigClusterSettings.fromJson(json[r'ClusterSettings']),
        metricsSettings: ConfigMetricsSettings.fromJson(json[r'MetricsSettings']),
        analyticsSettings: ConfigAnalyticsSettings.fromJson(json[r'AnalyticsSettings']),
      );
    }
    return null;
  }
  ...
  static Map<String, List<Config>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Config.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
