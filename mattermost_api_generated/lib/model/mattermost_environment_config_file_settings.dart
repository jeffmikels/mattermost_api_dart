...
class MattermostEnvironmentConfigFileSettings {
  /// Returns a new [MattermostEnvironmentConfigFileSettings] instance.
  MattermostEnvironmentConfigFileSettings({
    this.maxFileSize,
    this.driverName,
    this.directory,
  ...
  /// Returns a new [MattermostEnvironmentConfigFileSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostEnvironmentConfigFileSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostEnvironmentConfigFileSettings(
  ...
  static List<MattermostEnvironmentConfigFileSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostEnvironmentConfigFileSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostEnvironmentConfigFileSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostEnvironmentConfigFileSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostEnvironmentConfigFileSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
