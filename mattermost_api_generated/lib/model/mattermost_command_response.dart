...
class MattermostCommandResponse {
  /// Returns a new [MattermostCommandResponse] instance.
  ...
  /// Returns a new [MattermostCommandResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCommandResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCommandResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCommandResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostCommandResponse(
        ...
        attachments: MattermostSlackAttachment.listFromJson(json[r'Attachments']) ?? const [],
      );
    }
    return null;
  }
  ...
  static List<MattermostCommandResponse>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCommandResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCommandResponse> mapFromJson(dynamic json) {
    final map = <String, MattermostCommandResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCommandResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
