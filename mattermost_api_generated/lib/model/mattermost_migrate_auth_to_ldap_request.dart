...
class MattermostMigrateAuthToLdapRequest {
  /// Returns a new [MattermostMigrateAuthToLdapRequest] instance.
  MattermostMigrateAuthToLdapRequest({
    required this.from,
  ...
  /// Returns a new [MattermostMigrateAuthToLdapRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostMigrateAuthToLdapRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostMigrateAuthToLdapRequest(
  ...
  static List<MattermostMigrateAuthToLdapRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostMigrateAuthToLdapRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostMigrateAuthToLdapRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostMigrateAuthToLdapRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostMigrateAuthToLdapRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
