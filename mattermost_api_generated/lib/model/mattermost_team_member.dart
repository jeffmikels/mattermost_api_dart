...
class MattermostTeamMember {
  /// Returns a new [MattermostTeamMember] instance.
  ...
  /// Returns a new [MattermostTeamMember] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostTeamMember? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostTeamMember[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostTeamMember[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostTeamMember(
  ...
  static List<MattermostTeamMember>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostTeamMember.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostTeamMember> mapFromJson(dynamic json) {
    final map = <String, MattermostTeamMember>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostTeamMember.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
