...
class MattermostMoveCommandRequest {
  /// Returns a new [MattermostMoveCommandRequest] instance.
  ...
  /// Returns a new [MattermostMoveCommandRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostMoveCommandRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostMoveCommandRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostMoveCommandRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostMoveCommandRequest(
  ...
  static List<MattermostMoveCommandRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostMoveCommandRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostMoveCommandRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostMoveCommandRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostMoveCommandRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
