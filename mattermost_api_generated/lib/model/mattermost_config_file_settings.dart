...
class MattermostConfigFileSettings {
  /// Returns a new [MattermostConfigFileSettings] instance.
  MattermostConfigFileSettings({
    this.maxFileSize,
    this.driverName,
    this.directory,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MattermostConfigFileSettings &&
  ...
  /// Returns a new [MattermostConfigFileSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConfigFileSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConfigFileSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConfigFileSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostConfigFileSettings(
  ...
  static List<MattermostConfigFileSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MattermostConfigFileSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConfigFileSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConfigFileSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostConfigFileSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigFileSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MattermostConfigFileSettings-objects as value to a dart map
  static Map<String, List<MattermostConfigFileSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MattermostConfigFileSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigFileSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
