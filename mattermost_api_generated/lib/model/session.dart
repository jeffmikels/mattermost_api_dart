...
class Session {
  ...
  @override
  String toString() => 'Session[createAt=$createAt, deviceId=$deviceId, expiresAt=$expiresAt, id=$id, isOauth=$isOauth, lastActivityAt=$lastActivityAt, props=$props, roles=$roles, teamMembers=$teamMembers, token=$token, userId=$userId]';
