...
class Group {
  ...
  @override
  String toString() => 'Group[id=$id, name=$name, displayName=$displayName, description=$description, source_=$source_, remoteId=$remoteId, createAt=$createAt, updateAt=$updateAt, deleteAt=$deleteAt, hasSyncables=$hasSyncables]';
