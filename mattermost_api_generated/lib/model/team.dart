...
class Team {
  ...
  @override
  String toString() => 'Team[id=$id, createAt=$createAt, updateAt=$updateAt, deleteAt=$deleteAt, displayName=$displayName, name=$name, description=$description, email=$email, type=$type, allowedDomains=$allowedDomains, inviteId=$inviteId, allowOpenInvite=$allowOpenInvite, policyId=$policyId]';
