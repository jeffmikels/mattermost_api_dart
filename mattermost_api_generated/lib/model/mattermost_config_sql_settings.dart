...
class MattermostConfigSqlSettings {
  /// Returns a new [MattermostConfigSqlSettings] instance.
  MattermostConfigSqlSettings({
    this.driverName,
    this.dataSource,
  ...
  /// Returns a new [MattermostConfigSqlSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConfigSqlSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConfigSqlSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConfigSqlSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MattermostConfigSqlSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConfigSqlSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConfigSqlSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostConfigSqlSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigSqlSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
