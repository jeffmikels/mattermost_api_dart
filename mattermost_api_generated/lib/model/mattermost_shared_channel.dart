...
class MattermostSharedChannel {
  /// Returns a new [MattermostSharedChannel] instance.
  MattermostSharedChannel({
    this.id,
    this.teamId,
    this.home,
    this.readonly,
  ...
  /// Returns a new [MattermostSharedChannel] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSharedChannel? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostSharedChannel[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostSharedChannel[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostSharedChannel(
  ...
  static List<MattermostSharedChannel>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSharedChannel.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSharedChannel> mapFromJson(dynamic json) {
    final map = <String, MattermostSharedChannel>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSharedChannel.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
