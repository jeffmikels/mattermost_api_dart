...
class MattermostSwitchAccountTypeRequest {
  /// Returns a new [MattermostSwitchAccountTypeRequest] instance.
  ...
  /// Returns a new [MattermostSwitchAccountTypeRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostSwitchAccountTypeRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostSwitchAccountTypeRequest(
  ...
  static List<MattermostSwitchAccountTypeRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostSwitchAccountTypeRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostSwitchAccountTypeRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostSwitchAccountTypeRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostSwitchAccountTypeRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
