...
class MattermostPatchTeamRequest {
  /// Returns a new [MattermostPatchTeamRequest] instance.
  ...
  /// Returns a new [MattermostPatchTeamRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPatchTeamRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPatchTeamRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPatchTeamRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostPatchTeamRequest(
  ...
  static List<MattermostPatchTeamRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPatchTeamRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPatchTeamRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostPatchTeamRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPatchTeamRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
