...
class MattermostDataRetentionPolicyWithoutId {
  /// Returns a new [MattermostDataRetentionPolicyWithoutId] instance.
  MattermostDataRetentionPolicyWithoutId({
    this.displayName,
    this.postDuration,
  });
  ...
  /// Returns a new [MattermostDataRetentionPolicyWithoutId] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostDataRetentionPolicyWithoutId? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostDataRetentionPolicyWithoutId(
  ...
  static List<MattermostDataRetentionPolicyWithoutId>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostDataRetentionPolicyWithoutId.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostDataRetentionPolicyWithoutId> mapFromJson(dynamic json) {
    final map = <String, MattermostDataRetentionPolicyWithoutId>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostDataRetentionPolicyWithoutId.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
