...
class MattermostDataRetentionPolicyWithTeamAndChannelIds {
  /// Returns a new [MattermostDataRetentionPolicyWithTeamAndChannelIds] instance.
  ...
  /// Returns a new [MattermostDataRetentionPolicyWithTeamAndChannelIds] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostDataRetentionPolicyWithTeamAndChannelIds? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MattermostDataRetentionPolicyWithTeamAndChannelIds>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostDataRetentionPolicyWithTeamAndChannelIds.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostDataRetentionPolicyWithTeamAndChannelIds> mapFromJson(dynamic json) {
    final map = <String, MattermostDataRetentionPolicyWithTeamAndChannelIds>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostDataRetentionPolicyWithTeamAndChannelIds.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
