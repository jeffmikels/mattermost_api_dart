...
class TeamMember {
  ...
  @override
  String toString() => 'TeamMember[teamId=$teamId, userId=$userId, roles=$roles, deleteAt=$deleteAt, schemeUser=$schemeUser, schemeAdmin=$schemeAdmin, explicitRoles=$explicitRoles]';
