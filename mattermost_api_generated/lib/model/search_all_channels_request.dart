...
class SearchAllChannelsRequest {
  /// Returns a new [SearchAllChannelsRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchAllChannelsRequest &&
     other.term == term &&
  ...
  /// Returns a new [SearchAllChannelsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SearchAllChannelsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SearchAllChannelsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SearchAllChannelsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SearchAllChannelsRequest(
  ...
  static List<SearchAllChannelsRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchAllChannelsRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SearchAllChannelsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SearchAllChannelsRequest> mapFromJson(dynamic json) {
    final map = <String, SearchAllChannelsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchAllChannelsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SearchAllChannelsRequest-objects as value to a dart map
  static Map<String, List<SearchAllChannelsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SearchAllChannelsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchAllChannelsRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
