...
class Post {
  ...
  @override
  String toString() => 'Post[id=$id, createAt=$createAt, updateAt=$updateAt, deleteAt=$deleteAt, editAt=$editAt, userId=$userId, channelId=$channelId, rootId=$rootId, originalId=$originalId, message=$message, type=$type, props=$props, hashtag=$hashtag, fileIds=$fileIds, pendingPostId=$pendingPostId, metadata=$metadata]';
  ...
  static Post? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Post(
        ...
        metadata: PostMetadata.fromJson(json[r'metadata']),
      );
    }
    return null;
  }
