...
class MattermostCreateOAuthAppRequest {
  /// Returns a new [MattermostCreateOAuthAppRequest] instance.
  ...
  /// Returns a new [MattermostCreateOAuthAppRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostCreateOAuthAppRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostCreateOAuthAppRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostCreateOAuthAppRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostCreateOAuthAppRequest(
  ...
  static List<MattermostCreateOAuthAppRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostCreateOAuthAppRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostCreateOAuthAppRequest> mapFromJson(dynamic json) {
    final map = <String, MattermostCreateOAuthAppRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostCreateOAuthAppRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
