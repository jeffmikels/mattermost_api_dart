...
class MattermostChannelWithTeamDataAllOf {
  /// Returns a new [MattermostChannelWithTeamDataAllOf] instance.
  MattermostChannelWithTeamDataAllOf({
  ...
  /// Returns a new [MattermostChannelWithTeamDataAllOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostChannelWithTeamDataAllOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MattermostChannelWithTeamDataAllOf(
  ...
  static List<MattermostChannelWithTeamDataAllOf>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostChannelWithTeamDataAllOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostChannelWithTeamDataAllOf> mapFromJson(dynamic json) {
    final map = <String, MattermostChannelWithTeamDataAllOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostChannelWithTeamDataAllOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
