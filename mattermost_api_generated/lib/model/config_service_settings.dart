...
class ConfigServiceSettings {
  /// Returns a new [ConfigServiceSettings] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConfigServiceSettings &&
  ...
  /// Returns a new [ConfigServiceSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConfigServiceSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConfigServiceSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConfigServiceSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ConfigServiceSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConfigServiceSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConfigServiceSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConfigServiceSettings> mapFromJson(dynamic json) {
    final map = <String, ConfigServiceSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigServiceSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConfigServiceSettings-objects as value to a dart map
  static Map<String, List<ConfigServiceSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConfigServiceSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigServiceSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
