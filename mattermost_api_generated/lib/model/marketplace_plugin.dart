...
class MarketplacePlugin {
  /// Returns a new [MarketplacePlugin] instance.
  MarketplacePlugin({
    this.homepageUrl,
    this.iconData,
    this.downloadUrl,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MarketplacePlugin &&
  ...
  @override
  String toString() => 'MarketplacePlugin[homepageUrl=$homepageUrl, iconData=$iconData, downloadUrl=$downloadUrl, releaseNotesUrl=$releaseNotesUrl, labels=$labels, signature=$signature, manifest=$manifest, installedVersion=$installedVersion]';
  ...
  /// Returns a new [MarketplacePlugin] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MarketplacePlugin? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MarketplacePlugin[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MarketplacePlugin[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return MarketplacePlugin(
        ...
        manifest: PluginManifest.fromJson(json[r'manifest']),
  ...
  static List<MarketplacePlugin>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MarketplacePlugin>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MarketplacePlugin.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MarketplacePlugin> mapFromJson(dynamic json) {
    final map = <String, MarketplacePlugin>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MarketplacePlugin.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MarketplacePlugin-objects as value to a dart map
  static Map<String, List<MarketplacePlugin>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MarketplacePlugin>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MarketplacePlugin.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
