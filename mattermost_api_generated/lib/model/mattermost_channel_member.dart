...
class MattermostChannelMember {
  /// Returns a new [MattermostChannelMember] instance.
  ...
  /// Returns a new [MattermostChannelMember] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostChannelMember? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostChannelMember[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostChannelMember[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostChannelMember(
        ...
        notifyProps: MattermostChannelNotifyProps.fromJson(json[r'notify_props']),
  ...
  static List<MattermostChannelMember>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostChannelMember.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostChannelMember> mapFromJson(dynamic json) {
    final map = <String, MattermostChannelMember>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostChannelMember.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
