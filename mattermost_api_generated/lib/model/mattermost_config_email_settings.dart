...
class MattermostConfigEmailSettings {
  /// Returns a new [MattermostConfigEmailSettings] instance.
  MattermostConfigEmailSettings({
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  int? emailBatchingInterval;

  @override
  bool operator ==(Object other) => identical(this, other) || other is MattermostConfigEmailSettings &&
  ...
  /// Returns a new [MattermostConfigEmailSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConfigEmailSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConfigEmailSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConfigEmailSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostConfigEmailSettings(
  ...
  static List<MattermostConfigEmailSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MattermostConfigEmailSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConfigEmailSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConfigEmailSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostConfigEmailSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigEmailSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MattermostConfigEmailSettings-objects as value to a dart map
  static Map<String, List<MattermostConfigEmailSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MattermostConfigEmailSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigEmailSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
