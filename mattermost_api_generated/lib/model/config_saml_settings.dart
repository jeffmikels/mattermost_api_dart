...
class ConfigSamlSettings {
  /// Returns a new [ConfigSamlSettings] instance.
  ConfigSamlSettings({
    this.enable,
    this.verify,
    this.encrypt,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ConfigSamlSettings &&
     other.enable == enable &&
     other.verify == verify &&
  ...
  /// Returns a new [ConfigSamlSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ConfigSamlSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ConfigSamlSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ConfigSamlSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ConfigSamlSettings(
  ...
  static List<ConfigSamlSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ConfigSamlSettings>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ConfigSamlSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ConfigSamlSettings> mapFromJson(dynamic json) {
    final map = <String, ConfigSamlSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigSamlSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ConfigSamlSettings-objects as value to a dart map
  static Map<String, List<ConfigSamlSettings>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ConfigSamlSettings>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConfigSamlSettings.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
