...
class MattermostPluginManifest {
  /// Returns a new [MattermostPluginManifest] instance.
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  MattermostPluginManifestBackend? backend;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  MattermostPluginManifestServer? server;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  MattermostPluginManifestWebapp? webapp;
  ...
  /// Returns a new [MattermostPluginManifest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostPluginManifest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostPluginManifest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostPluginManifest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostPluginManifest(
        id: mapValueOfType<String>(json, r'id'),
        name: mapValueOfType<String>(json, r'name'),
        description: mapValueOfType<String>(json, r'description'),
        version: mapValueOfType<String>(json, r'version'),
        minServerVersion: mapValueOfType<String>(json, r'min_server_version'),
        backend: MattermostPluginManifestBackend.fromJson(json[r'backend']),
        server: MattermostPluginManifestServer.fromJson(json[r'server']),
        webapp: MattermostPluginManifestWebapp.fromJson(json[r'webapp']),
  ...
  static List<MattermostPluginManifest>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostPluginManifest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostPluginManifest> mapFromJson(dynamic json) {
    final map = <String, MattermostPluginManifest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostPluginManifest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
