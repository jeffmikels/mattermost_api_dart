...
class MattermostConfigLdapSettings {
  /// Returns a new [MattermostConfigLdapSettings] instance.
  MattermostConfigLdapSettings({
    this.enable,
    this.ldapServer,
    this.ldapPort,
  ...
  /// Returns a new [MattermostConfigLdapSettings] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MattermostConfigLdapSettings? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MattermostConfigLdapSettings[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MattermostConfigLdapSettings[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return MattermostConfigLdapSettings(
  ...
  static List<MattermostConfigLdapSettings>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MattermostConfigLdapSettings.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MattermostConfigLdapSettings> mapFromJson(dynamic json) {
    final map = <String, MattermostConfigLdapSettings>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MattermostConfigLdapSettings.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
