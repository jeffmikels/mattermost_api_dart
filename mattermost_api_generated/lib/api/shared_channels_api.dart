...
class SharedChannelsApi {
  SharedChannelsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  ///
  /// * [int] perPage:
  Future<List<SharedChannel>?> getAllSharedChannels(String teamId, { int? page, int? perPage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<SharedChannel>') as List)
        .cast<SharedChannel>()
        .toList();
  ...
  Future<RemoteClusterInfo?> getRemoteClusterInfo(String remoteId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'RemoteClusterInfo',) as RemoteClusterInfo;
