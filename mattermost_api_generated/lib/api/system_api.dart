...
class SystemApi {
  ...
  ///
  /// Performs a database integrity check.   __Note__: This check may temporarily harm system performance.   __Minimum server version__: 5.28.0   __Local mode only__: This endpoint is only available through [local mode](https://docs.mattermost.com/administration/mmctl-cli-tool.html#local-mode). 
  Future<List<IntegrityCheckResult>?> checkIntegrity() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<IntegrityCheckResult>') as List)
        .cast<IntegrityCheckResult>()
        .toList();
  ...
  /// * [int] perPage:
  ///   The number of audits per page.
  Future<List<Audit>?> getAudits({ int? page, int? perPage, }) async {
  ...
  Future<EnvironmentConfig?> getEnvironmentConfig() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EnvironmentConfig',) as EnvironmentConfig;
  ...
  /// * [String] locale:
  ///   Client locale
  Future<List<Notice>?> getNotices(String clientVersion, String client, String teamId, { String? locale, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<Notice>') as List)
        .cast<Notice>()
        .toList();
  ...
  /// * [String] deviceId:
  ///   Check whether this device id can receive push notifications
  Future<SystemStatusResponse?> getPing({ bool? getServerStatus, String? deviceId, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'SystemStatusResponse',) as SystemStatusResponse;
  ...
  /// * [String] url (required):
  ///   Url to check
  Future<GetRedirectLocation200Response?> getRedirectLocation(String url,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetRedirectLocation200Response',) as GetRedirectLocation200Response;
  ...
  Future<ServerBusy?> getServerBusyExpires() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ServerBusy',) as ServerBusy;
  ...
  /// * [List<String>] requestBody (required):
  ///   Array of notice IDs
  Future<StatusOK?> markNoticesViewed(List<String> requestBody,) async {
  ...
  Future<Response> patchConfigWithHttpInfo(Config config,) async {
    // ignore: prefer_const_declarations
  ...
  Future<Config?> patchConfig(Config config,) async {
    final response = await patchConfigWithHttpInfo(config,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Parameters:
  ///
  /// * [PostLogRequest] postLogRequest (required):
  Future<Response> postLogWithHttpInfo(PostLogRequest postLogRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/logs';

    // ignore: prefer_final_locals
    Object? postBody = postLogRequest;
  ...
  ///
  /// * [PostLogRequest] postLogRequest (required):
  Future<List<String>?> postLog(PostLogRequest postLogRequest,) async {
    final response = await postLogWithHttpInfo(postLogRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<LicenseRenewalLink?> requestLicenseRenewalLink() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'LicenseRenewalLink',) as LicenseRenewalLink;
  ...
  /// Parameters:
  ///
  /// * [RequestTrialLicenseRequest] requestTrialLicenseRequest (required):
  ///   License request
  Future<Response> requestTrialLicenseWithHttpInfo(RequestTrialLicenseRequest requestTrialLicenseRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/trial-license';

    // ignore: prefer_final_locals
    Object? postBody = requestTrialLicenseRequest;
  ...
  /// * [RequestTrialLicenseRequest] requestTrialLicenseRequest (required):
  ///   License request
  Future<void> requestTrialLicense(RequestTrialLicenseRequest requestTrialLicenseRequest,) async {
    final response = await requestTrialLicenseWithHttpInfo(requestTrialLicenseRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  ///   Warn Metric Id.
  ///
  /// * [SendWarnMetricAckRequest] sendWarnMetricAckRequest (required):
  ///   payload that contains the ack flag
  Future<Response> sendWarnMetricAckWithHttpInfo(String warnMetricId, SendWarnMetricAckRequest sendWarnMetricAckRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/warn_metrics/ack/{warn_metric_id}'
      .replaceAll('{warn_metric_id}', warnMetricId);

    // ignore: prefer_final_locals
    Object? postBody = sendWarnMetricAckRequest;
  ...
  /// * [SendWarnMetricAckRequest] sendWarnMetricAckRequest (required):
  ///   payload that contains the ack flag
  Future<StatusOK?> sendWarnMetricAck(String warnMetricId, SendWarnMetricAckRequest sendWarnMetricAckRequest,) async {
    final response = await sendWarnMetricAckWithHttpInfo(warnMetricId, sendWarnMetricAckRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [Config] config (required):
  ///   Mattermost configuration
  Future<Response> testEmailWithHttpInfo(Config config,) async {
    // ignore: prefer_const_declarations
  ...
  Future<StatusOK?> testEmail(Config config,) async {
    final response = await testEmailWithHttpInfo(config,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [Config] config (required):
  ///   Mattermost configuration
  Future<Response> testS3ConnectionWithHttpInfo(Config config,) async {
    // ignore: prefer_const_declarations
  ...
  Future<StatusOK?> testS3Connection(Config config,) async {
    final response = await testS3ConnectionWithHttpInfo(config,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Parameters:
  ///
  /// * [TestSiteURLRequest] testSiteURLRequest (required):
  Future<Response> testSiteURLWithHttpInfo(TestSiteURLRequest testSiteURLRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/site_url/test';

    // ignore: prefer_final_locals
    Object? postBody = testSiteURLRequest;
  ...
  ///
  /// * [TestSiteURLRequest] testSiteURLRequest (required):
  Future<StatusOK?> testSiteURL(TestSiteURLRequest testSiteURLRequest,) async {
    final response = await testSiteURLWithHttpInfo(testSiteURLRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> updateMarketplaceVisitedByAdminWithHttpInfo(System system,) async {
    // ignore: prefer_const_declarations
  ...
  Future<StatusOK?> updateMarketplaceVisitedByAdmin(System system,) async {
    final response = await updateMarketplaceVisitedByAdminWithHttpInfo(system,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<PushNotification?> upgradeToEnterprise() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PushNotification',) as PushNotification;
  ...
  ///
  /// It returns the percentage of completion of the current upgrade or the error if there is any. __Minimum server version__: 5.27 ##### Permissions Must have `manage_system` permission. 
  Future<UpgradeToEnterpriseStatus200Response?> upgradeToEnterpriseStatus() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'UpgradeToEnterpriseStatus200Response',) as UpgradeToEnterpriseStatus200Response;
