...
class GroupsApi {
  ...
  ///   The ID of the group.
  ///
  /// * [AddGroupMembersRequest] addGroupMembersRequest (required):
  Future<Response> addGroupMembersWithHttpInfo(String groupId, AddGroupMembersRequest addGroupMembersRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/groups/{group_id}/members'
      .replaceAll('{group_id}', groupId);

    // ignore: prefer_final_locals
    Object? postBody = addGroupMembersRequest;
  ...
  ///
  /// * [AddGroupMembersRequest] addGroupMembersRequest (required):
  Future<StatusOK?> addGroupMembers(String groupId, AddGroupMembersRequest addGroupMembersRequest,) async {
    final response = await addGroupMembersWithHttpInfo(groupId, addGroupMembersRequest,);
  ...
  Future<Response> createGroupWithHttpInfo(CreateGroupRequest createGroupRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/groups';
  ...
  Future<void> createGroup(CreateGroupRequest createGroupRequest,) async {
    final response = await createGroupWithHttpInfo(createGroupRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  /// * [String] groupId (required):
  ///   The ID of the group.
  Future<StatusOK?> deleteGroup(String groupId,) async {
  ...
  ///
  /// * [DeleteGroupMembersRequest] deleteGroupMembersRequest (required):
  Future<Response> deleteGroupMembersWithHttpInfo(String groupId, DeleteGroupMembersRequest deleteGroupMembersRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/groups/{group_id}/members'
      .replaceAll('{group_id}', groupId);

    // ignore: prefer_final_locals
    Object? postBody = deleteGroupMembersRequest;
  ...
  ///
  /// * [DeleteGroupMembersRequest] deleteGroupMembersRequest (required):
  Future<StatusOK?> deleteGroupMembers(String groupId, DeleteGroupMembersRequest deleteGroupMembersRequest,) async {
    final response = await deleteGroupMembersWithHttpInfo(groupId, deleteGroupMembersRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] groupId (required):
  ///   Group GUID
  Future<GetGroupStats200Response?> getGroupStats(String groupId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetGroupStats200Response',) as GetGroupStats200Response;
  ...
  Future<GroupSyncableChannel?> getGroupSyncableForChannelId(String groupId, String channelId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GroupSyncableChannel',) as GroupSyncableChannel;
  ...
  Future<GroupSyncableTeam?> getGroupSyncableForTeamId(String groupId, String teamId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GroupSyncableTeam',) as GroupSyncableTeam;
  ...
  /// * [String] groupId (required):
  ///   Group GUID
  Future<List<GroupSyncableChannels>?> getGroupSyncablesChannels(String groupId,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<GroupSyncableChannels>') as List)
        .cast<GroupSyncableChannels>()
        .toList();
  ...
  /// * [String] groupId (required):
  ///   Group GUID
  Future<List<GroupSyncableTeams>?> getGroupSyncablesTeams(String groupId,) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<GroupSyncableTeams>') as List)
        .cast<GroupSyncableTeams>()
        .toList();
  ...
  /// * [int] perPage:
  ///   The number of groups per page.
  Future<GetGroupUsers200Response?> getGroupUsers(String groupId, { int? page, int? perPage, }) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetGroupUsers200Response',) as GetGroupUsers200Response;
  ...
  /// * [bool] filterAllowReference:
  ///   Boolean which filters the group entries with the `allow_reference` attribute set.
  Future<List<Group>?> getGroups(String notAssociatedToTeam, String notAssociatedToChannel, { int? page, int? perPage, String? q, bool? includeMemberCount, int? since, bool? filterAllowReference, }) async {
  ...
  /// * [bool] paginate:
  ///   Boolean to determine whether the pagination should be applied or not
  Future<List<Map<String, List<GroupWithSchemeAdmin>>>?> getGroupsAssociatedToChannelsByTeam(String teamId, { int? page, int? perPage, bool? filterAllowReference, bool? paginate, }) async {
  ...
  /// * [bool] filterAllowReference:
  ///   Boolean which filters the group entries with the `allow_reference` attribute set.
  Future<List<Group>?> getGroupsByChannel(String channelId, { int? page, int? perPage, bool? filterAllowReference, }) async {
  ...
  /// * [bool] filterAllowReference:
  ///   Boolean which filters in the group entries with the `allow_reference` attribute set.
  Future<List<Group>?> getGroupsByTeam(String teamId, { int? page, int? perPage, bool? filterAllowReference, }) async {
  ...
  ///   Group GUID
  ///
  /// * [PatchGroupRequest] patchGroupRequest (required):
  ///   Group object that is to be updated
  Future<Response> patchGroupWithHttpInfo(String groupId, PatchGroupRequest patchGroupRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/groups/{group_id}/patch'
      .replaceAll('{group_id}', groupId);

    // ignore: prefer_final_locals
    Object? postBody = patchGroupRequest;
  ...
  /// * [PatchGroupRequest] patchGroupRequest (required):
  ///   Group object that is to be updated
  Future<Group?> patchGroup(String groupId, PatchGroupRequest patchGroupRequest,) async {
    final response = await patchGroupWithHttpInfo(groupId, patchGroupRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///   Channel GUID
  ///
  /// * [PatchGroupSyncableForTeamRequest] patchGroupSyncableForTeamRequest (required):
  ///   GroupSyncable object that is to be updated
  Future<Response> patchGroupSyncableForChannelWithHttpInfo(String groupId, String channelId, PatchGroupSyncableForTeamRequest patchGroupSyncableForTeamRequest,) async {
    // ignore: prefer_const_declarations
    ...
    // ignore: prefer_final_locals
    Object? postBody = patchGroupSyncableForTeamRequest;
  ...
  /// * [PatchGroupSyncableForTeamRequest] patchGroupSyncableForTeamRequest (required):
  ///   GroupSyncable object that is to be updated
  Future<GroupSyncableChannel?> patchGroupSyncableForChannel(String groupId, String channelId, PatchGroupSyncableForTeamRequest patchGroupSyncableForTeamRequest,) async {
    final response = await patchGroupSyncableForChannelWithHttpInfo(groupId, channelId, patchGroupSyncableForTeamRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [PatchGroupSyncableForTeamRequest] patchGroupSyncableForTeamRequest (required):
  ///   GroupSyncable object that is to be updated
  Future<Response> patchGroupSyncableForTeamWithHttpInfo(String groupId, String teamId, PatchGroupSyncableForTeamRequest patchGroupSyncableForTeamRequest,) async {
    // ignore: prefer_const_declarations
  ...
  /// * [PatchGroupSyncableForTeamRequest] patchGroupSyncableForTeamRequest (required):
  ///   GroupSyncable object that is to be updated
  Future<GroupSyncableTeam?> patchGroupSyncableForTeam(String groupId, String teamId, PatchGroupSyncableForTeamRequest patchGroupSyncableForTeamRequest,) async {
    final response = await patchGroupSyncableForTeamWithHttpInfo(groupId, teamId, patchGroupSyncableForTeamRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
