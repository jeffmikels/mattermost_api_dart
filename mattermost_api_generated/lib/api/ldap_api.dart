...
class LdapApi {
  LdapApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  /// * [int] perPage:
  ///   The number of users per page. There is a maximum limit of 200 users per page.
  Future<List<LDAPGroupsPaged>?> getLdapGroups({ String? q, int? page, int? perPage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<LDAPGroupsPaged>') as List)
        .cast<LDAPGroupsPaged>()
        .toList();
  ...
  /// * [String] remoteId (required):
  ///   Group GUID
  Future<StatusOK?> linkLdapGroup(String remoteId,) async {
