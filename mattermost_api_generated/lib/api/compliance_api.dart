...
class ComplianceApi {
  ...
  Future<Compliance?> createComplianceReport() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'Compliance',) as Compliance;
  ...
  /// * [int] perPage:
  ///   The number of reports per page.
  Future<List<Compliance>?> getComplianceReports({ int? page, int? perPage, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<Compliance>') as List)
        .cast<Compliance>()
        .toList();
