...
final api_instance = JobsApi();
final createJobRequest = CreateJobRequest(); // CreateJobRequest | Job object to be created
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **createJobRequest** | [**CreateJobRequest**](CreateJobRequest.md)| Job object to be created | 
...
# **getJobsByType**
> List<Job> getJobsByType(type, page, perPage)
