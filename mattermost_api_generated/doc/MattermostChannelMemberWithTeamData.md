# mattermost_api.model.MattermostChannelMemberWithTeamData
...
MattermostChannelMemberWithTeamData example = await client.channelMemberWithTeamData.FUNCTION_THAT_RETURNS_THIS_CLASS();
