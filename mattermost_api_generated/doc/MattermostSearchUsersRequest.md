# mattermost_api.model.MattermostSearchUsersRequest
...
MattermostSearchUsersRequest example = await client.searchUsersRequest.FUNCTION_THAT_RETURNS_THIS_CLASS();
