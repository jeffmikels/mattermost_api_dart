...
// tests for MattermostRemoveRecentCustomStatusRequest
void main() {
  // final instance = MattermostRemoveRecentCustomStatusRequest();

  group('test MattermostRemoveRecentCustomStatusRequest', () {
    // Any emoji
    // String emoji
