...
// tests for MattermostUpdatePostRequest
void main() {
  // final instance = MattermostUpdatePostRequest();

  group('test MattermostUpdatePostRequest', () {
    ...
    // bool hasReactions
    test('to test the property `hasReactions`', () async {
      // TODO
    });
