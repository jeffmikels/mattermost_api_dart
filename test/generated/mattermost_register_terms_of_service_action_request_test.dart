...
// tests for MattermostRegisterTermsOfServiceActionRequest
void main() {
  // final instance = MattermostRegisterTermsOfServiceActionRequest();

  group('test MattermostRegisterTermsOfServiceActionRequest', () {
