...
// tests for SearchAllChannels200Response
void main() {
  // final instance = SearchAllChannels200Response();

  group('test SearchAllChannels200Response', () {
    // The channels that matched the query.
    // List<Channel> channels (default value: const [])
