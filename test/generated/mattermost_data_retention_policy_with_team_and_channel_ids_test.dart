...
// tests for MattermostDataRetentionPolicyWithTeamAndChannelIds
void main() {
  // final instance = MattermostDataRetentionPolicyWithTeamAndChannelIds();

  group('test MattermostDataRetentionPolicyWithTeamAndChannelIds', () {
