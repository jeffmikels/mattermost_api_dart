...
void main() {
  // final instance = PostListWithSearchMatches();

  group('test PostListWithSearchMatches', () {
    // List<String> order (default value: const [])
    test('to test the property `order`', () async {
      // TODO
    });

    // Map<String, Post> posts (default value: const {})
    ...
    // Map<String, List<String>> matches (default value: const {})
