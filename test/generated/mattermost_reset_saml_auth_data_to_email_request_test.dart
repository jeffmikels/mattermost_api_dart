...
// tests for MattermostResetSamlAuthDataToEmailRequest
void main() {
  // final instance = MattermostResetSamlAuthDataToEmailRequest();

  group('test MattermostResetSamlAuthDataToEmailRequest', () {
