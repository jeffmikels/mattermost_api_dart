...
// tests for MattermostRemoteClusterInfo
void main() {
  // final instance = MattermostRemoteClusterInfo();

  group('test MattermostRemoteClusterInfo', () {
    ...
    // int lastPingAt
    test('to test the property `lastPingAt`', () async {
      // TODO
    });
