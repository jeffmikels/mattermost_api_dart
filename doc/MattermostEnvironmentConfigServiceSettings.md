# mattermost_api.model.MattermostEnvironmentConfigServiceSettings
...
MattermostEnvironmentConfigServiceSettings example = await client.environmentConfigServiceSettings.FUNCTION_THAT_RETURNS_THIS_CLASS();
