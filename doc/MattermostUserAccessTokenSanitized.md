# mattermost_api.model.MattermostUserAccessTokenSanitized
...
MattermostUserAccessTokenSanitized example = await client.userAccessTokenSanitized.FUNCTION_THAT_RETURNS_THIS_CLASS();
