# mattermost_api.model.MattermostEnvironmentConfigTeamSettings
...
MattermostEnvironmentConfigTeamSettings example = await client.environmentConfigTeamSettings.FUNCTION_THAT_RETURNS_THIS_CLASS();
