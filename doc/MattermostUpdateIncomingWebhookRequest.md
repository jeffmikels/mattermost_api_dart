# mattermost_api.model.MattermostUpdateIncomingWebhookRequest
...
MattermostUpdateIncomingWebhookRequest example = await client.updateIncomingWebhookRequest.FUNCTION_THAT_RETURNS_THIS_CLASS();
