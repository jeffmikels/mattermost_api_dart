# mattermost_api.model.MattermostRetentionPolicyForTeamList
...
MattermostRetentionPolicyForTeamList example = await client.retentionPolicyForTeamList.FUNCTION_THAT_RETURNS_THIS_CLASS();
