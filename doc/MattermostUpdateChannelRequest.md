# mattermost_api.model.MattermostUpdateChannelRequest
...
MattermostUpdateChannelRequest example = await client.updateChannelRequest.FUNCTION_THAT_RETURNS_THIS_CLASS();
