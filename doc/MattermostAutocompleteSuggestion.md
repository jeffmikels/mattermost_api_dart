# mattermost_api.model.MattermostAutocompleteSuggestion
...
MattermostAutocompleteSuggestion example = await client.autocompleteSuggestion.FUNCTION_THAT_RETURNS_THIS_CLASS();
