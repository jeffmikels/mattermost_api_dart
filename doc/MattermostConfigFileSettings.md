# mattermost_api.model.MattermostConfigFileSettings
...
MattermostConfigFileSettings example = await client.configFileSettings.FUNCTION_THAT_RETURNS_THIS_CLASS();
