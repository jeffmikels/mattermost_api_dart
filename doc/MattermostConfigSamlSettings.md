# mattermost_api.model.MattermostConfigSamlSettings
...
MattermostConfigSamlSettings example = await client.configSamlSettings.FUNCTION_THAT_RETURNS_THIS_CLASS();
