# mattermost_api.model.MattermostDataRetentionPolicyWithoutId
...
MattermostDataRetentionPolicyWithoutId example = await client.dataRetentionPolicyWithoutId.FUNCTION_THAT_RETURNS_THIS_CLASS();
